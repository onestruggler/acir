...
# ForStdlib
  ...
  Provides stuff that is should be in the stdlib. E.g., semidirect,
  amalgamation product of monoids and groups.
...
# Syntactics
- Base — the monoid congruence `_≈_` generated by a raw relation `_===_`
