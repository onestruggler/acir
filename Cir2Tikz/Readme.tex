...
\usepackage{hyperref}
\usepackage{graphicx}
% Screenshots live in img/; pictures in figures/ (found by \tikzfig itself).
\graphicspath{{img/}}
\usepackage{tikz}
\usepackage{tikzit}
...
\begin{figure}[!htb]
  ...
  \centering \scalebox{0.8}{\tikzfig{tc2}} \includegraphics[width=0.35\textwidth]{tikzit}
...
\item[2.] Load the style file ``circuits.tikzstyles'' you just
  ...
  \begin{figure}[h]
    \centering \includegraphics[width=0.5\textwidth]{load-style}
  \end{figure}
...
\item[4.] Click ``Tools $\rightarrow$ Make Preview'' to preview your
  ...
  \begin{figure}[H]
    \centering \includegraphics[width=0.5\textwidth]{preview}
  \end{figure}
