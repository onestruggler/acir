...
main :: IO ()
main = do
  writeFile "fig1_sigma.tikz"     (tikz_of_pcir fig1)
  writeFile "fig2_comm2.tikz"     (tikz_of_pcir fig2_comm2)
  writeFile "fig2_yb.tikz"        (tikz_of_pcir fig2_yb)
  writeFile "fig3_staircase.tikz" (tikz_of_cir (cir_trans staircase))
