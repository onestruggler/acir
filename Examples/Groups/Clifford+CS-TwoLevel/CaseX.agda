...
--
-- The Main Lemma for the basic generator G = X_[α,α+1] (Case 3 of the
-- Appendix), β = α + 1, but for one subcase, left as the hypothesis
-- Hard (proved in CaseXM).  With p the pivot, w the numerator of the
-- pivot column and k its least denominator exponent:
--
...
module Examples.Groups.Clifford+CS-TwoLevel.CaseX {n : ℕ} where
...
open import Examples.Groups.Clifford+CS-TwoLevel.Syllable
  using (syl ; step ; Within-^ ; Beyond-actM ; eᶻ ; eᶻ-! ; δᶻ-refl ; δᶻ-≢ ; col𝕀≡)
open import Examples.Groups.Clifford+CS-TwoLevel.Levels using (Bℓ ; nodd-X ; Minimal-X)
open import Examples.Groups.Clifford+CS-TwoLevel.Derived {n}
  using (X-X ; K-K† ; K†-K ; IX≈XL ; K†LX≈XI³LK†L ; conj-^ ; flip-X ; Apartʷ ; Apartʷʷ)
...
private
  ...
  R-X-X {j} {k} {l} jk kl f = begin
    (X j l jl • i j ^ f) • X k l kl       ≈⟨ assoc ⟩
    X j l jl • (i j ^ f • X k l kl)       ≈⟨ cright conj-^ (axiom (comm-iX kl (FinP.<⇒≢ jk) (FinP.<⇒≢ jl))) f ⟩
    X j l jl • (X k l kl • i j ^ f)       ≈⟨ sym assoc ⟩
    (X j l jl • X k l kl) • i j ^ f       ≈⟨ cleft trans (axiom (swap-XX′ jk kl)) (axiom (swap-XX jk kl)) ⟩
    (X j k jk • X j l jl) • i j ^ f       ≈⟨ assoc ⟩
  ...
  R-X-i {j} {k} {l} jk kl f = begin
    (X k l kl • i k ^ f) • X j k jk       ≈⟨ assoc ⟩
    X k l kl • (i k ^ f • X j k jk)       ≈⟨ cright conj-^ (axiom (swap-iX jk)) f ⟩
    X k l kl • (X j k jk • i j ^ f)       ≈⟨ sym assoc ⟩
    (X k l kl • X j k jk) • i j ^ f       ≈⟨ cleft axiom (swap-XX jk kl) ⟩
    (X j k jk • X j l jl) • i j ^ f       ≈⟨ assoc ⟩
    X j k jk • (X j l jl • i j ^ f)       ∎
    where jl = FinP.<-trans jk kl

  -- (case 3.1.2.1), merging.
  R-merge : ∀ {j k : Fin n} (jk : j < k) f → (X j k jk • i j ^ f) • X j k jk ≈ i k ^ f
  R-merge {j} {k} jk f = begin
    (X j k jk • i j ^ f) • X j k jk       ≈⟨ assoc ⟩
    X j k jk • (i j ^ f • X j k jk)       ≈⟨ cright conj-^ (IX≈XL jk) f ⟩
    X j k jk • (X j k jk • i k ^ f)       ≈⟨ sym assoc ⟩
    (X j k jk • X j k jk) • i k ^ f       ≈⟨ cleft X-X jk ⟩
    ε • i k ^ f                           ≈⟨ left-unit ⟩
    i k ^ f                               ∎
  ...
  R-K-X {j} {k} {l} jk kl q = begin
    (K† j l jl • i l ^ q) • X k l kl      ≈⟨ assoc ⟩
    K† j l jl • (i l ^ q • X k l kl)      ≈⟨ cright conj-^ (axiom (swap-iX kl)) q ⟩
    K† j l jl • (X k l kl • i k ^ q)      ≈⟨ sym assoc ⟩
    (K† j l jl • X k l kl) • i k ^ q      ≈⟨ cleft conj-^ (axiom (swap-KX′ jk kl)) 7 ⟩
    (X k l kl • K† j k jk) • i k ^ q      ≈⟨ assoc ⟩
    X k l kl • (K† j k jk • i k ^ q)      ∎
    where jl = FinP.<-trans jk kl

  -- (cases 3.2.2.6 and 3.2.2.7)
  R-X-K : ∀ {j k l : Fin n} (jk : j < k) (kl : k < l) q →
          (K† k l kl • i l ^ q) • X j k jk ≈ X j k jk • (K† j l (FinP.<-trans jk kl) • i l ^ q)
  R-X-K {j} {k} {l} jk kl q = begin
    (K† k l kl • i l ^ q) • X j k jk      ≈⟨ assoc ⟩
    K† k l kl • (i l ^ q • X j k jk)      ≈⟨ cright conj-^ (axiom (comm-iX jk (≢-sym (FinP.<⇒≢ jl)) (≢-sym (FinP.<⇒≢ kl)))) q ⟩
    K† k l kl • (X j k jk • i l ^ q)      ≈⟨ sym assoc ⟩
    (K† k l kl • X j k jk) • i l ^ q      ≈⟨ cleft conj-^ (axiom (swap-KX jk kl)) 7 ⟩
    (X j k jk • K† j l jl) • i l ^ q      ≈⟨ assoc ⟩
  ...
  R-K†X {j} {k} jk = begin
    ...
    K† j k jk • X j k jk                              ≈⟨ sym right-unit ⟩
    (K† j k jk • X j k jk) • ε                        ≈⟨ cright sym (K-K† jk) ⟩
    (K† j k jk • X j k jk) • (K j k jk • K† j k jk)   ≈⟨ by-assoc auto ⟩
    K† j k jk • (X j k jk • K j k jk) • K† j k jk     ≈⟨ cright cleft sym (axiom (rel-13 jk)) ⟩
    K† j k jk • (K j k jk • i k ^ 2) • K† j k jk      ≈⟨ by-assoc auto ⟩
    (K† j k jk • K j k jk) • i k ^ 2 • K† j k jk      ≈⟨ cleft K†-K jk ⟩
    ε • i k ^ 2 • K† j k jk                           ≈⟨ left-unit ⟩
...
------------------------------------------------------------------------
-- k = 0 with the pivot at β (case 3.1.2)
...
module Top (α β : Fin n) (αβ1 : toℕ β ≡ suc (toℕ α))
  ...
  top0 k0 = go (unit k0)
    ...
    -- The unit at α.
    at-α : ∀ {m} → m ≡ α → firstOdd W ≡ just m → ∀ t → t ℕ.< 4 → W ! m ≡ ⅈᶻ ^ᶻ t →
           (∀ y → y ≢ m → W ! y ≡ ZR.0#) → Square G s o
    at-α ≡.refl fo t t<4 ua rest = by-t t t<4 ua
      where
      U = Xᶻ α β W
      syl-s : ∀ {t} → W ! α ≡ ⅈᶻ ^ᶻ t → syl s ≡ X α β αβ • i α ^ invExp (ⅈᶻ ^ᶻ t)
      syl-s ua = ≡.trans (syl-of s ps 0 W v≡₀ (inj₁ ≡.refl))
                   (≡.trans (sylData-unit< W fo αβ) (≡.cong (λ z → X α β αβ • i α ^ invExp z) ua))
      ...
      -- (case 3.1.2.2): the syllable of r, after G, is that of s.
      merge : ∀ {t} → W ! α ≡ ⅈᶻ ^ᶻ t → ⅈᶻ ^ᶻ t ≢ ZR.1# → Square G s o
      merge {t} ua bad = square-merge G s o pr rel
        where
        pr : pivot r ≡ just β
        pr = pivot-stay G s FinP.≤-refl ps
               (ne-𝕀-at r β 0 U (col-r v≡₀) (inj₁ ≡.refl) β
                 (λ e → bad (≡.trans (≡.sym (≡.trans (Xᶻ-β W) ua)) (≡.trans e (≡.trans (eᶻ-! β β) (δᶻ-refl β))))))
        syl-r : syl r ≡ i β ^ invExp (ⅈᶻ ^ᶻ t)
        syl-r = ≡.trans (syl-of r pr 0 U (col-r v≡₀) (inj₁ ≡.refl))
                  (≡.trans (sylData-unit≡ U foU) (≡.cong (λ z → i β ^ invExp z) (≡.trans (Xᶻ-β W) ua)))
        rel : syl r • X α β αβ ≈ syl s
        rel = trans (cleft refl′ syl-r)
                (trans (conj-^ (axiom (swap-iX αβ)) (invExp (ⅈᶻ ^ᶻ t))) (refl′ (≡.sym (syl-s {t} ua))))
      by-t : ∀ t → t ℕ.< 4 → W ! α ≡ ⅈᶻ ^ᶻ t → Square G s o
    ...
    -- The unit at β (case 3.1.2.1).
    at-β : ∀ {m} → m ≡ β → firstOdd W ≡ just m → ∀ t → t ℕ.< 4 → W ! m ≡ ⅈᶻ ^ᶻ t →
           (∀ y → y ≢ m → W ! y ≡ ZR.0#) → Square G s o
    at-β ≡.refl fo t t<4 ua rest = by-t t t<4 ua
      where
      U = Xᶻ α β W
      Wα : W ! α ≡ ZR.0#
      Wα = rest α α≢β
      ...
      pr = pivot-stay G s FinP.≤-refl ps
             (ne-𝕀-at r β 0 U (col-r v≡₀) (inj₁ ≡.refl) β
               (λ e → 0≢1 (≡.trans (≡.sym (≡.trans (Xᶻ-β W) Wα)) (≡.trans e (≡.trans (eᶻ-! β β) (δᶻ-refl β))))))
      merge : ∀ {t} → W ! β ≡ ⅈᶻ ^ᶻ t → Square G s o
      merge {t} ua = square-merge G s o pr rel
        where
        syl-r : syl r ≡ X α β αβ • i α ^ invExp (ⅈᶻ ^ᶻ t)
        syl-r = ≡.trans (syl-of r pr 0 U (col-r v≡₀) (inj₁ ≡.refl))
                  (≡.trans (sylData-unit< U foU αβ) (≡.cong (λ z → X α β αβ • i α ^ invExp z) (≡.trans (Xᶻ-α W) ua)))
        syl-s : syl s ≡ i β ^ invExp (ⅈᶻ ^ᶻ t)
        syl-s = ≡.trans (syl-of s ps 0 W v≡₀ (inj₁ ≡.refl))
                  (≡.trans (sylData-unit≡ W fo) (≡.cong (λ z → i β ^ invExp z) ua))
        rel : syl r • X α β αβ ≈ syl s
        rel = trans (cleft refl′ syl-r) (trans (R-merge αβ (invExp (ⅈᶻ ^ᶻ t))) (refl′ (≡.sym syl-s)))
      by-t : ∀ t → t ℕ.< 4 → W ! β ≡ ⅈᶻ ^ᶻ t → Square G s o
      ...
      by-t 0 _ ua = ⊥-elim (proj₁ (pivot-just s ps) (≡.trans v≡₀ (≡.trans (≡.cong (scV 0) W≡e) (≡.sym (col𝕀≡ β)))))
        ...
        at x (no x≢β) = ≡.trans (rest x x≢β) (≡.sym (≡.trans (eᶻ-! β x) (δᶻ-≢ x≢β)))
        W≡e : W ≡ eᶻ β
    ...
    go : (∃ λ m → firstOdd W ≡ just m × ∃ λ t → t ℕ.< 4 × W ! m ≡ ⅈᶻ ^ᶻ t × (∀ y → y ≢ m → W ! y ≡ ZR.0#)) →
         Square G s o
    go (m , fo , t , t<4 , um , rest) = by-m (FinP.<-cmp m α)
      where
      m≤β : m ≤ β
      m≤β = odd≤ (proj₁ (firstOdd-spec W fo))
      by-m : Tri (m < α) (m ≡ α) (α < m) → Square G s o
      -- m < α (case 3.1.2.3): the syllable stays, and the square closes
      -- through X_[m,α].
      ...
      by-m (tri≈ _ m≡α _) = at-α m≡α fo t t<4 um rest
      by-m (tri> _ _ α<m) = at-β (FinP.≤-antisym m≤β (β≤ α<m)) fo t t<4 um rest
...
module _ (α β : Fin n) (αβ1 : toℕ β ≡ suc (toℕ α))
  ...
  -- The subcase left to CaseXM (case 3.2.2.2 with w_β odd): k > 0,
  -- the first two odd entries are j < α, and w_β is odd.
  Hard : Set
  ...
  private
    ...
    ------------------------------------------------------------------
    -- α ≥ p: retrograde (cases 3.1.1 and 3.2.1)
    ...
    retro p≤α = square-retro G s o ps pr back
      ...
      Uα : U ! α ≡ ZR.1#
      Uα = ≡.trans (Xᶻ-α (eᶻ β)) (≡.trans (eᶻ-! β β) (δᶻ-refl β))
      Uβ : U ! β ≡ ZR.0#
      Uβ = ≡.trans (Xᶻ-β (eᶻ β)) (≡.trans (eᶻ-! β α) (δᶻ-≢ α≢β))
      fo : firstOdd U ≡ just α
      fo = firstOdd-char U (≡.cong oddᶻ Uα)
             (λ x xα → ≡.cong oddᶻ (≡.trans (Xᶻ-≢ (eᶻ β) (FinP.<⇒≢ xα) (FinP.<⇒≢ (ℕP.<-trans xα αβ)))
                                          (≡.trans (eᶻ-! β x) (δᶻ-≢ (FinP.<⇒≢ (ℕP.<-trans xα αβ))))))
      ne : col r β ≢ col 𝕀 β
      ne = ne-𝕀-at r β 0 U colβ (inj₁ ≡.refl) β
             (λ e → 0≢1 (≡.trans (≡.sym Uβ) (≡.trans e (≡.trans (eᶻ-! β β) (δᶻ-refl β)))))
        where
        0≢1 : ZR.0# ≢ ZR.1#
        0≢1 ()
      pr : pivot r ≡ just β
      ...
      syl-r = ≡.trans (syl-of r pr 0 U colβ (inj₁ ≡.refl))
                (≡.trans (sylData-unit< U fo αβ) (≡.cong (λ z → X α β αβ • i α ^ invExp z) Uα))
      back : syl r • [ G ]ʷ ≈ ε
      back = trans (cleft refl′ syl-r) (trans (cleft right-unit) (X-X αβ))

    ------------------------------------------------------------------
    -- k = 0 and β < p (case 3.1.3)
    ...
    case0 k0 β<p = go (unit k0)
      ...
      go (m , fo , t , t<4 , um , rest) = by-m (FinP.<-cmp m α)
        ...
        at-α ≡.refl fo′ ua rest′ =
          square-syl G s o (X β p β<p • i β ^ invExp (ⅈᶻ ^ᶻ t)) (X α β αβ) pr syl-r
            (word-below-all (X α β αβ) ℕP.≤-refl (step s) (lt-step s o ps) bβ)
            (trans (R-X-i αβ β<p (invExp (ⅈᶻ ^ᶻ t))) (cright refl′ (≡.sym syl-s)))
          where
          U = Xᶻ α β W
          foU : firstOdd U ≡ just β
          foU = firstOdd-char U (≡.subst Odd (≡.sym (Xᶻ-β W)) (proj₁ (firstOdd-spec W fo′)))
          ...
          pr = pivot-stay G s (ℕP.<⇒≤ β<p) ps
                 (ne-𝕀-at r p 0 U (col-r v≡₀) (inj₁ ≡.refl) p
                   (λ e → 0≢1 (≡.trans (≡.sym (≡.trans (Xᶻ-≢ W p≢α p≢β) (rest′ p p≢α)))
                                       (≡.trans e (≡.trans (eᶻ-! p p) (δᶻ-refl p))))))
            where
            0≢1 : ZR.0# ≢ ZR.1#
            0≢1 ()
          syl-r : syl r ≡ X β p β<p • i β ^ invExp (ⅈᶻ ^ᶻ t)
          syl-r = ≡.trans (syl-of r pr 0 U (col-r v≡₀) (inj₁ ≡.refl))
                    (≡.trans (sylData-unit< U foU β<p)
                             (≡.cong (λ z → X β p β<p • i β ^ invExp z) (≡.trans (Xᶻ-β W) ua)))
          syl-s : syl s ≡ X α p α<p • i α ^ invExp (ⅈᶻ ^ᶻ t)
          syl-s = ≡.trans (syl-of s ps 0 W v≡₀ (inj₁ ≡.refl))
                    (≡.trans (sylData-unit< W fo′ α<p) (≡.cong (λ z → X α p α<p • i α ^ invExp z) ua))
        at-β : ∀ {m′} → m′ ≡ β → firstOdd W ≡ just m′ → W ! m′ ≡ ⅈᶻ ^ᶻ t → (∀ y → y ≢ m′ → W ! y ≡ ZR.0#) →
               Square G s o
        at-β ≡.refl fo′ ua rest′ =
          square-syl G s o (X α p α<p • i α ^ invExp (ⅈᶻ ^ᶻ t)) (X α β αβ) pr syl-r
            (word-below-all (X α β αβ) ℕP.≤-refl (step s) (lt-step s o ps) bβ)
            (trans (flip-X αβ (R-X-i αβ β<p (invExp (ⅈᶻ ^ᶻ t)))) (cright refl′ (≡.sym syl-s)))
          where
          U = Xᶻ α β W
          foU : firstOdd U ≡ just α
          foU = firstOdd-char U (≡.subst Odd (≡.sym (Xᶻ-α W)) (proj₁ (firstOdd-spec W fo′)))
          ...
          pr = pivot-stay G s (ℕP.<⇒≤ β<p) ps
            ...
            0≢1 : ZR.0# ≢ ZR.1#
            0≢1 ()
          syl-r : syl r ≡ X α p α<p • i α ^ invExp (ⅈᶻ ^ᶻ t)
          syl-r = ≡.trans (syl-of r pr 0 U (col-r v≡₀) (inj₁ ≡.refl))
                    (≡.trans (sylData-unit< U foU α<p)
                             (≡.cong (λ z → X α p α<p • i α ^ invExp z) (≡.trans (Xᶻ-α W) ua)))
          syl-s : syl s ≡ X β p β<p • i β ^ invExp (ⅈᶻ ^ᶻ t)
          syl-s = ≡.trans (syl-of s ps 0 W v≡₀ (inj₁ ≡.refl))
                    (≡.trans (sylData-unit< W fo′ β<p) (≡.cong (λ z → X β p β<p • i β ^ invExp z) ua))

        by-m : Tri (m < α) (m ≡ α) (α < m) → Square G s o
        by-m (tri< m<α _ _) = same m≢α m≢β
            (≡.subst (λ w → Apartʷ w G) (≡.sym syl-s)
              ((m≢α ∷ m≢β ∷ []) ∷ (p≢α ∷ p≢β ∷ []) ∷ [] , Apartʷ-^ (i m) G ((m≢α ∷ m≢β ∷ []) ∷ []) f))
          where
          m≢α = FinP.<⇒≢ m<α
          m<β = ℕP.<-trans m<α αβ
          m≢β = FinP.<⇒≢ m<β
          m<p = ℕP.<-trans m<β β<p
          syl-s : syl s ≡ X m p m<p • i m ^ f
    ...
    case+ {K′} ks α<p hard = at-j first
      ...
      syl-U : ∀ {j′ ℓ′} → firstOdd U ≡ just j′ → nextOdd j′ U ≡ just ℓ′ → (jℓ : j′ < ℓ′) →
              syl r ≡ K† j′ ℓ′ jℓ • i ℓ′ ^ qOf (U ! j′) (U ! ℓ′)
      ...
      syl-W : ∀ {j ℓ} → firstOdd W ≡ just j → nextOdd j W ≡ just ℓ → (jℓ : j < ℓ) →
              syl s ≡ K† j ℓ jℓ • i ℓ ^ qOf (W ! j) (W ! ℓ)
      ...
      evenβ {j} fo nx eβ =
        square-syl G s o (K† j β jβ • i β ^ q) (X α β αβ) pr syl-r (below (X α β αβ) ℕP.≤-refl)
          (trans (R-K-X jα αβ q) (cright refl′ (≡.sym (syl-W fo nx jα))))
        where
        jα : j < α
        ...
        syl-r : syl r ≡ K† j β jβ • i β ^ q
        syl-r = ≡.trans (syl-U foU nxU jβ) (≡.cong₂ (λ x y → K† j β jβ • i β ^ qOf x y) Uj (Xᶻ-β W))

      -- ℓ = β, j < α (case 3.2.2.4).
      βnext : ∀ {j} → firstOdd W ≡ just j → nextOdd j W ≡ just β → j < α → Square G s o
      βnext {j} fo nx jα =
        square-syl G s o (K† j α jα • i α ^ q) (X α β αβ) pr syl-r (below (X α β αβ) ℕP.≤-refl)
          (trans (flip-X αβ (R-K-X jα αβ q)) (cright refl′ (≡.sym (syl-W fo nx jβ))))
        where
        jβ : j < β
        ...
        syl-r = ≡.trans (syl-U foU nxU jα) (≡.cong₂ (λ x y → K† j α jα • i α ^ qOf x y) Uj (Xᶻ-α W))

      -- j = α, ℓ = β (case 3.2.2.3).
      pairαβ : firstOdd W ≡ just α → nextOdd α W ≡ just β → Square G s o
      pairαβ fo nx = by-q (qOf (W ! α) (W ! β)) (qOf-≤1 (W ! α) (W ! β)) ≡.refl
        where
        foU : firstOdd U ≡ just α
        foU = firstOdd-char U (≡.subst Odd (≡.sym (Xᶻ-α W)) (proj₁ (proj₂ (nextOdd-spec W nx))))
                (λ x xα → ≡.subst Even (≡.sym (Xᶻ-≢ W (FinP.<⇒≢ xα) (FinP.<⇒≢ (ℕP.<-trans xα αβ))))
                                  (proj₂ (firstOdd-spec W fo) x xα))
        nxU : nextOdd α U ≡ just β
        nxU = nextOdd-char U αβ (≡.subst Odd (≡.sym (Xᶻ-β W)) (proj₁ (firstOdd-spec W fo)))
                (λ x αx xβ → ⊥-elim (none-αβ αx xβ))
        syl-r : syl r ≡ K† α β αβ • i β ^ qOf (W ! α) (W ! β)
        syl-r = ≡.trans (syl-U foU nxU αβ)
                  (≡.cong (λ z → K† α β αβ • i β ^ z)
                    (≡.trans (≡.cong₂ qOf (Xᶻ-α W) (Xᶻ-β W)) (qOf-sym (W ! β) (W ! α))))
        by-q : ∀ q → q ℕ.≤ 1 → qOf (W ! α) (W ! β) ≡ q → Square G s o
        by-q 0 _ e =
          square-syl G s o (K† α β αβ • ε) (i β ^ 2) pr
            (≡.trans syl-r (≡.cong (λ z → K† α β αβ • i β ^ z) e))
            (below (i β ^ 2) (ℕP.≤-refl , ℕP.≤-refl))
            (trans (R-K†X αβ) (cright refl′ (≡.sym (≡.trans (syl-W fo nx αβ) (≡.cong (λ z → K† α β αβ • i β ^ z) e)))))
        by-q 1 _ e =
          square-syl G s o (K† α β αβ • i β) (X α β αβ • i α ^ 3 • i β) pr
            (≡.trans syl-r (≡.cong (λ z → K† α β αβ • i β ^ z) e))
            (below (X α β αβ • i α ^ 3 • i β) (ℕP.≤-refl , (α≤β , α≤β , α≤β) , ℕP.≤-refl))
            (trans (R-K†LX αβ) (cright refl′ (≡.sym (≡.trans (syl-W fo nx αβ) (≡.cong (λ z → K† α β αβ • i β ^ z) e)))))
        by-q (suc (suc _)) (s≤s ()) _

      -- j = α, β < ℓ (case 3.2.2.6).
      αfirst : ∀ {ℓ} → firstOdd W ≡ just α → nextOdd α W ≡ just ℓ → β < ℓ → Square G s o
      αfirst {ℓ} fo nx βℓ =
        square-syl G s o (K† β ℓ βℓ • i ℓ ^ q) (X α β αβ) pr syl-r (below (X α β αβ) ℕP.≤-refl)
          (trans (R-X-K αβ βℓ q) (cright refl′ (≡.sym (syl-W fo nx αℓ))))
        where
        αℓ : α < ℓ
        ...
        syl-r : syl r ≡ K† β ℓ βℓ • i ℓ ^ q
        syl-r = ≡.trans (syl-U foU nxU βℓ) (≡.cong₂ (λ x y → K† β ℓ βℓ • i ℓ ^ qOf x y) (Xᶻ-β W) (Xᶻ-≢ W ℓ≢α ℓ≢β))

      -- j = β (case 3.2.2.7).
      βfirst : ∀ {ℓ} → firstOdd W ≡ just β → nextOdd β W ≡ just ℓ → Square G s o
      βfirst {ℓ} fo nx =
        square-syl G s o (K† α ℓ αℓ • i ℓ ^ q) (X α β αβ) pr syl-r (below (X α β αβ) ℕP.≤-refl)
          (trans (flip-X αβ (R-X-K αβ βℓ q)) (cright refl′ (≡.sym (syl-W fo nx βℓ))))
        where
        βℓ : β < ℓ
        ...
        syl-r : syl r ≡ K† α ℓ αℓ • i ℓ ^ q
        syl-r = ≡.trans (syl-U foU nxU αℓ) (≡.cong₂ (λ x y → K† α ℓ αℓ • i ℓ ^ qOf x y) (Xᶻ-α W) (Xᶻ-≢ W ℓ≢α ℓ≢β))
          ...
          by-ℓα (tri< ℓα _ _) =
            keep fo nx (Xᶻ-≢ W (FinP.<⇒≢ jα) (FinP.<⇒≢ (ℕP.<-trans jα αβ)))
                       ...
                       (λ x jx xℓ → ≡.subst Even (≡.sym (Xᶻ-≢ W (FinP.<⇒≢ (ℕP.<-trans xℓ ℓα))
                                             ...
                                             (btw x jx xℓ))
                       (≡.subst (λ w → Apartʷ w G) (≡.sym syl-s)
                         (within-apart (K† j ℓ jℓ • i ℓ ^ q)
                           (Within-^ (K j ℓ jℓ) FinP.≤-refl 7 , Within-^ (i ℓ) FinP.≤-refl q) G (ℓα ∷ ℓβ ∷ [])))
            where
            jα = ℕP.<-trans jℓ ℓα
            ℓβ = ℕP.<-trans ℓα αβ
            ...
            by-ℓβ (inj₁ βℓ) = by-jα (FinP.<-cmp j α)
              ...
              by-jα (tri< jα _ _) =
                keep fo nx (Xᶻ-≢ W (FinP.<⇒≢ jα) (FinP.<⇒≢ jβ)) (Xᶻ-≢ W ℓ≢α ℓ≢β)
                  ...
                  (≡.subst (λ w → Apartʷ w G) (≡.sym syl-s)
                    (Apartʷ-^ (K j ℓ jℓ) G ((j≢α ∷ j≢β ∷ []) ∷ (ℓ≢α ∷ ℓ≢β ∷ []) ∷ []) 7 ,
                     Apartʷ-^ (i ℓ) G ((ℓ≢α ∷ ℓ≢β ∷ []) ∷ []) q))
                where
                jβ = ℕP.<-trans jα αβ
                j≢α = FinP.<⇒≢ jα
                j≢β = FinP.<⇒≢ jβ
