...
module Examples.Groups.Clifford+CS-TwoLevel.Pivot where
...
open import Instances using (_≟_)
open import Quantum.Synthesis.Matrix using (Matrix)
open import Quantum.Synthesis.Ring
  using (SemiRingDyadic ; RingDyadic ; AdjointDyadic ; DecEqDyadic ; SemiRingCplx ; RingCplx ; AdjointCplx ; DecEqCplx)

open import Word.Base using (Word ; [_]ʷ ; ε ; _•_)
open import Examples.Groups.Clifford+CS-TwoLevel.Ring
open import Examples.Groups.Clifford+CS-TwoLevel.Lde using (lde ; num)
