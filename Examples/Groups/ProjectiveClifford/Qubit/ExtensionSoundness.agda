...
module Examples.Groups.ProjectiveClifford.Qubit.ExtensionSoundness where
...
open import Examples.Groups.ProjectiveClifford.Qubit.CliffordGroup using (identityˡᶜ)
...
open import Examples.Groups.ProjectiveClifford.Qubit.CliffordGroup using (incl-2)
