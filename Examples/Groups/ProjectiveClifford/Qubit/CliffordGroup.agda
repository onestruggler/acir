...
module Examples.Groups.ProjectiveClifford.Qubit.CliffordGroup where
...
open import Examples.Groups.Pauli.Qubit.SignedPauli using (P4Carrier)
open import Examples.Groups.ProjectiveClifford.Qubit.CliffordAction using (cact)
open import Examples.Groups.ProjectiveClifford.Qubit.CliffordAut using (g4-id)
...
open import Examples.Groups.Pauli.Qubit.SignedPauli using (Φ ; ι ; ι-+)
...
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.Action using (cact-X↓ ; cact-Z↓)
...
open import Examples.Groups.Pauli.Qubit.SignedPauli using (+-swap-middle)
...
open import Examples.Groups.Pauli.Qubit.SignedPauli using (γ ; γ-εˡ ; _·_)
