...
module Examples.Groups.ProjectiveClifford.Qubit.ExtensionPresentation where
...
open import ForStdlib.Data.Fin.Mod.Prime.Two using (g* ; g-gen)
...
open import Examples.Groups.ProjectiveClifford.Qubit.Realises using (vec-gen)
