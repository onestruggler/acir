...
module Examples.Groups.ProjectiveClifford.Qubit.Selinger.Conjugation where
...
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.PauliWords using (module XZ ; module ↑Comm)
