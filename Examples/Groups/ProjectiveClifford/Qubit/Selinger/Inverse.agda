...
module Examples.Groups.ProjectiveClifford.Qubit.Selinger.Inverse where
...
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.PauliVec using (P-X ; P-Z)
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.PauliSide
  using (Z-order ; c8-pauli ; c9-pauli ; comm-Z₀-X₁)
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.Extension
