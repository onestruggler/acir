...
module Examples.Groups.ProjectiveClifford.Qubit.Selinger.Relators where
...
open import Examples.Groups.ProjectiveClifford.Qubit.Selinger.PauliVec using (P-Z ; Z₀≡)
