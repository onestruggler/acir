...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.SemiM
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.LemmasXZ
  p-3 p-prime g* g-gen
...
-- ════════════════════════════════════════════════════════════════════
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.LemmasCZ p-3 p-prime g* g-gen using (lemma-comm-Z↑-CZ ; lemma-comm-Z-CZ ; lemma-M₋₁-CZ)
