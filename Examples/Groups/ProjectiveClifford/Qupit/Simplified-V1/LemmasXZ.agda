...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.LemmasXZ
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.Lemmas p-3 p-prime g* g-gen using (module Lemmas1 ; module Clifford-GroupLike)
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.Tactics p-3 p-prime g* g-gen using (module Sim-Rewriting)
