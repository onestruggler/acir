...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Lemmas
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Syntactics p-3 p-prime g* g-gen
open Simplified-Relations


-- ====================================================================
-- Lemmas1-S : copy of Simplified-V1.Lemmas's Lemmas1 (order + M
--             machinery)
-- ====================================================================
module Lemmas1-S (n : ℕ) where
  ...
  {- DEAD CLUSTER (commented out 2026-06-23).
     These four lemmas (lemma-MgR^k, lemma-MgR^k', lemma-Mg^kR, lemma-semi-MR)
     are -S copies of the Clifford Lemmas1 generalisations of semi-MR.  They are
     unused anywhere in the Simplified subtree, and they depend on `axiom semi-MR`
     ...
     Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.SemiM.SemiS.completeness-semi-MR; repointing these here
  ...
  {- DEAD CLUSTER (commented out 2026-06-23): -S copies of the semi-MR
     generalisations (lemma-MgR^k', lemma-Mg^kR, lemma-semi-MR).  Unused, and
     they reference the (now simplified, Wg-based) axiom semi-MR in its old
     original Mg-form.  The original form is recovered as
     Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.SemiM.SemiS.completeness-semi-MR (repointing here would
  ...
  lemma-semi-MR x = begin
    ...
    eqk : x .proj₁ ≡ (g^ k) .proj₁
    eqk = Eq.sym (lemma-log-inject x)
  -}  -- end DEAD cluster (lemma-MgR^k' / lemma-Mg^kR / lemma-semi-MR)
