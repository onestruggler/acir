...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Completeness
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Conjugation p-3 p-prime g* g-gen public
...
module C10Base (m : ℕ) where
  ...
  open PP ((₁₊ m) QRel,_===_)
  open SR word-setoid
  open Lemmas1-S m using (lemma-order-R ; lemma-order-H)
...
-- ====================================================================
-- Completeness: the original (R-form) selinger relations hold in the
