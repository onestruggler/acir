...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Iso
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Syntactics p-3 p-prime g* g-gen as Sim
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.Soundness p-3 p-prime g* g-gen as Snd
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Completeness p-3 p-prime g* g-gen as Cmp
...
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.SemiM   p-3 p-prime g* g-gen as MgC
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.SemiM p-3 p-prime g* g-gen as MgS
-- Clifford-side proofs of Z↔CZ (the new comm-Z-CZ / comm-Z↑-CZ axioms).
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V1.LemmasCZ p-3 p-prime g* g-gen as CliL
