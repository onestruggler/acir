...
module Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Presentation
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Syntactics
  p-3 p-prime g* g-gen as Sim using (module Simplified-Relations)
open import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Completeness
  p-3 p-prime g* g-gen as SimL using (module Simplified-GroupLike-S)
import Examples.Groups.ProjectiveClifford.Qupit.Simplified-V2.Iso
