...
--
-- Equation 15 of the 46 relations the Reidemeister-Schreier theorem
...
module Examples.Groups.Clifford+T-2qubit.Equations.Equation15 where
...
eqn15 : Clifford+T.Rel ⊢ Swap • Swap • ε === ε
eqn15 = 
  equational Swap • Swap • ε
