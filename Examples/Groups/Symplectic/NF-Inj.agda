...
module Examples.Groups.Symplectic.NF-Inj (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.NF p-2 p-prime using (act-nf)
open import Examples.Groups.Symplectic.NF-Inj-Base p-2 p-prime using (lemma-aux-vec)
open import Examples.Groups.Symplectic.NF-Inj-LM p-2 p-prime using (lemma-lm-head-inj ; lemma-lm-tail-surj)
