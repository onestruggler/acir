...
module Examples.Groups.Symplectic.Iso-Sym-Derived (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
g-well-defined {(₁₊ n)} (comm-H {g = g₁}) = begin
  g* ([ g₁ Gen₂.↥ ]ʷ • SymDerived.H) ≈⟨ refl₁ ⟩
  g* ([ g₁ Gen₂.↥ ]ʷ) • Sym.H ≈⟨ refl₁ ⟩
  g* ([ g₁ ]ʷ) Sym.↑ • Sym.H ≈⟨ sym₁ (Sym'.lemma-comm-H-w↑ (g g₁)) ⟩
  Sym.H • g* ([ g₁ ]ʷ) Sym.↑ ≈⟨ refl₁ ⟩
  g* (SymDerived.H • [ g₁ Gen₂.↥ ]ʷ) ∎
  where
  open PB ((₁₊ n) QRel,_===₁_) renaming (_≈_ to _≈₁_ ; refl to refl₁ ; cong to cong₁ ; sym to sym₁ ; axiom to axiom₁)
  open PP ((₁₊ n) QRel,_===₁_)
  open SR word-setoid
g-well-defined {(₁₊ n)} (comm-S {g = g₁}) = begin
  g* ([ g₁ Gen₂.↥ ]ʷ • SymDerived.S) ≈⟨ refl₁ ⟩
  g* ([ g₁ Gen₂.↥ ]ʷ) • Sym.S ≈⟨ refl₁ ⟩
  g* ([ g₁ ]ʷ) Sym.↑ • Sym.S ≈⟨ sym₁ (Sym'.lemma-comm-S-w↑ (g g₁)) ⟩
  Sym.S • g* ([ g₁ ]ʷ) Sym.↑ ≈⟨ refl₁ ⟩
  g* (SymDerived.S • [ g₁ Gen₂.↥ ]ʷ) ∎
  where
  open PB ((₁₊ n) QRel,_===₁_) renaming (_≈_ to _≈₁_ ; refl to refl₁ ; cong to cong₁ ; sym to sym₁ ; axiom to axiom₁)
  open PP ((₁₊ n) QRel,_===₁_)
  open SR word-setoid
g-well-defined {(₁₊ n)} (comm-CZ {g = g₁}) = begin
  g* ([ g₁ Gen₂.↥ Gen₂.↥ ]ʷ • SymDerived.CZ) ≈⟨ refl₁ ⟩
  g* ([ g₁ Gen₂.↥ Gen₂.↥ ]ʷ) • Sym.CZ ≈⟨ refl₁ ⟩
  g* ([ g₁ ]ʷ) Sym.↑  Sym.↑ • Sym.CZ ≈⟨ sym₁ (Sym'.lemma-comm-CZ-w↑ (g g₁)) ⟩
  Sym.CZ • g* ([ g₁ ]ʷ) Sym.↑ Sym.↑ ≈⟨ refl₁ ⟩
  g* (SymDerived.CZ • [ g₁ Gen₂.↥ Gen₂.↥ ]ʷ) ∎
  where
  open PB ((₁₊ n) QRel,_===₁_) renaming (_≈_ to _≈₁_ ; refl to refl₁ ; cong to cong₁ ; sym to sym₁ ; axiom to axiom₁)
  open PP ((₁₊ n) QRel,_===₁_)
  open SR word-setoid
