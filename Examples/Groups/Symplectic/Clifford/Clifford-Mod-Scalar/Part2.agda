...
module Examples.Groups.Symplectic.Clifford.Clifford-Mod-Scalar.Part2
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.Symplectic.Clifford.Clifford-Mod-Scalar.Part1 p-3 p-prime g* g-gen using (module Clifford-Relations)
