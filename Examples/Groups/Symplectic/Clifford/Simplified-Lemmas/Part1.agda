...
module Examples.Groups.Symplectic.Clifford.Simplified-Lemmas.Part1
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
module Lemmas1-S (n : ℕ) where
  ...
  {- DEAD CLUSTER (commented out 2026-06-23).
     ...
     Examples.Groups.Symplectic.Clifford.Mg-Simplify-S.SemiS.completeness-semi-M𝑠; repointing these here
  ...
  {- DEAD CLUSTER (commented out 2026-06-23): -S copies of the semi-M𝑠
     ...
     Examples.Groups.Symplectic.Clifford.Mg-Simplify-S.SemiS.completeness-semi-M𝑠 (repointing here would
