...
open import Relation.Binary.PropositionalEquality
  using (_≡_ ; _≢_ ; module ≡-Reasoning ; _≗_)
...
module Examples.Groups.Symplectic.NF (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.LM-Lemmas2 p-2 p-prime
open Normal-Form1
...
lemma-nf {n} w = nf , claim
  ...
  claim p = begin
    act-nf nf p ≡⟨ auto ⟩
    act-nf nf (act ε p) ≡⟨ Eq.sym (Eq.cong (act-nf nf) (act-cong (w ⁻¹ʷ • w) ε p  inverseˡ)) ⟩
