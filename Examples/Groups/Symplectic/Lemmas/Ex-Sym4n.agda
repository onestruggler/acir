...
module Examples.Groups.Symplectic.Lemmas.Ex-Sym4n (p-2 : ℕ) (p-prime : Prime (2+ p-2)) where
...
aux-CZ⁻¹-CZ' {n} = begin
  CZ⁻¹ • CZ ≈⟨ comm⇒pow-comm p-1 1 refl ⟩
...
lemma-CZ-ₕ|ₕ↑ {n} = begin
  ...
  aux0 = begin
    ...
    ((ₕ|ₕ ↑) • CZ⁻¹ • (CZ • (ₕ|ₕ ↑)) • ((⊥⊤ ↓) • (CZ ↑) • (⊤⊥ ↓)) • CZ • (ₕ|ₕ ↑)) •  CZ • (ₕ|ₕ ↑) ≈⟨ (cleft cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    ...
    (ₕ|ₕ ↑) • (CZ⁻¹ • CZ) • (ₕ|ₕ ↑) ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  ...
  aux = begin
    ...
    ε • ((ₕ|ₕ ↑) • (CZ⁻¹) • Ex • Ex • CZ • (ₕ|ₕ ↑)) ≈⟨ (cright by-passoc (□  ^ 6) (□ ^ 3 • □ ^ 3) auto) ⟩
    ...
    ε • ((ₕ|ₕ ↑) • CZ⁻¹ • Ex) • (CZ⁻¹ ↑ • CZ ↑) • Ex • CZ • (ₕ|ₕ ↑) ≈⟨ (cright by-passoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 4 • □ ^ 2) auto) ⟩
    ε • ((ₕ|ₕ ↑) • (CZ⁻¹) • Ex • CZ⁻¹ ↑) • CZ ↑ • Ex • CZ • (ₕ|ₕ ↑) ≈⟨ (cright cright rewrite-powers 1000 auto) ⟩
    ε • ((ₕ|ₕ ↑) • (CZ⁻¹) • Ex • CZ⁻¹ ↑) • Ex • Ex • CZ ↑ • Ex • CZ • (ₕ|ₕ ↑) ≈⟨ (cright by-passoc (□ ^ 4 • □ ^ 3) (□ ^ 5 • □ ^ 2) auto) ⟩
...
aux-comm-CZ02 {n} k l m = begin
  ...
  (Ex • (CZ ↑) • Ex) ^ k • CZ ^ (l Nat.* m) ≈⟨ comm⇒pow-comm k (l Nat.* m) (sym lemma-comm-CZ-CZ02) ⟩
  CZ ^ (l Nat.* m) • (Ex • (CZ ↑) • Ex) ^ k  ≈⟨ (cright aux-CZ02 k) ⟩
  CZ ^ (l Nat.* m) • (Ex • (CZ ↑ ^ k) • Ex) ≈⟨ cong (sym (^^ CZ l m)) (cright cleft refl' ( (lemma-^-↑ CZ k))) ⟩
  (CZ ^ l) ^ m • Ex • (CZ ^ k) ↑ • Ex ∎
  where
  open PB ((₃₊ n) QRel,_===_)
  open PP ((₃₊ n) QRel,_===_)
...
aux-CZ02k {n} k = begin
  ...
  Ex • (CZ ↑ • CZ ↑ ^ k) • Ex ≈⟨ (cright cleft sym (^-suc (CZ ↑) k)) ⟩
  CZ02k (₁₊ k) ∎
  where
  open PB ((₃₊ n) QRel,_===_)
  open PP ((₃₊ n) QRel,_===_)
...
lemma-CZ02k-alt {n} k@0 = rewrite-powers 100 auto
  where
  open Rewriting-Powers (₂₊ n)
lemma-CZ02k-alt {n} k@1 = begin
  Ex • CZ ↑ • Ex ≈⟨ sym lemma-CZ02-alt ⟩
  CZ02'k 1 ∎
  where
  open PB ((₃₊ n) QRel,_===_)
  open PP ((₃₊ n) QRel,_===_)
...
lemma-CZ02k-alt {n} k@(₁₊ k'@(₁₊ k'')) = begin
  ...
  Ex • (CZ ↑ • (Ex • Ex) • CZ ↑ ^ k') • Ex ≈⟨ by-passoc (□ • (□ • □ ^ 2 • □) • □) (□ ^ 3 • □ ^ 3) auto ⟩
  (Ex • CZ ↑ • Ex) • (Ex • CZ ↑ ^ k' • Ex) ≈⟨ cong (lemma-CZ02k-alt 1) (lemma-CZ02k-alt k') ⟩
  CZ02'k 1 • CZ02'k k' ≈⟨ aux-CZ02'k k' ⟩
  CZ02'k k ∎
  where
  open PB ((₃₊ n) QRel,_===_)
  open PP ((₃₊ n) QRel,_===_)
...
lemma-CZ02⁻ᵏ-alt {n} k@1 = begin
  ...
  CZ02 ^ p-1 ≈⟨ ^-cong _ _ p-1 (sym lemma-CZ02-alt) ⟩
...
lemma-CZ^k-ₕ|ₕ↑ {n} k@(₁₊ k'@(₁₊ k-2)) = begin
  ...
  (ₕ|ₕ ↑ • CZ⁻¹ • Ex • CZ⁻¹ ↑ • Ex) • CZ⁻¹ ^ k' • Ex • (CZ⁻¹ ^ k') ↑ • Ex ≈⟨ by-passoc (□ ^ 5 • □ ^ 4) (□ ^ 2 • (□ ^ 3 • □) • □ ^ 3) auto ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • ((Ex • CZ⁻¹ ↑ • Ex) • CZ⁻¹ ^ k') • Ex • (CZ⁻¹ ^ k') ↑ • Ex ≈⟨ (cright cleft aux-comm-CZ02 p-1 p-1 k') ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • (CZ⁻¹ ^ k' • (Ex • CZ⁻¹ ↑ • Ex)) • Ex • (CZ⁻¹ ^ k') ↑ • Ex ≈⟨ (cright  by-passoc ((□ • □ ^ 3) • □ ^ 3) (□ ^ 3 • □ ^ 2 • □ ^ 2) auto) ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • (CZ⁻¹ ^ k' • (Ex • CZ⁻¹ ↑)) • Ex ^ 2 • (CZ⁻¹ ^ k') ↑ • Ex ≈⟨ (cright  (cright trans (cleft lemma-order-Ex-n) left-unit)) ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • (CZ⁻¹ ^ k' • (Ex • CZ⁻¹ ↑)) • (CZ⁻¹ ^ k') ↑ • Ex ≈⟨ (cright  by-passoc (□ ^ 3 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □) auto) ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • (CZ⁻¹ ^ k' • Ex) • (CZ⁻¹ • CZ⁻¹ ^ k') ↑ • Ex ≈⟨ (cright  (cright cleft refl)) ⟩
  (ₕ|ₕ ↑ • CZ⁻¹) • (CZ⁻¹ ^ k' • Ex) • (CZ⁻¹ ^ k) ↑ • Ex ≈⟨ (  by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □ ^ 3) auto) ⟩
...
lemma-CX↑-CZ {n} = bbc CZ02 ε aux
  ...
  aux = begin
    ...
    CZ • (CZ02 • CZ02⁻¹) • CX ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
...
lemma-CX↑-CZ^k {n} k@(₁₊ k'@(₁₊ k'')) = begin
  ...
  (CZ • CZ02⁻¹ • CX ↑) • CZ ^ k' ≈⟨ by-passoc (□ ^ 3 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  (CZ • CZ02⁻¹) • CX ↑ • CZ ^ k' ≈⟨ (cright lemma-CX↑-CZ^k k') ⟩
  (CZ • CZ02⁻¹) • CZ ^ k' • CZ02⁻ᵏ k' • CX ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  CZ • (CZ02⁻¹ • CZ ^ k') • CZ02⁻ᵏ k' • CX ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 k' (sym lemma-comm-CZ-CZ02⁻¹)) ⟩
  CZ • (CZ ^ k' • CZ02⁻¹) • CZ02⁻ᵏ k' • CX ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □) auto ⟩
