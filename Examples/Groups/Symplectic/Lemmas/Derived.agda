...
module Examples.Groups.Symplectic.Lemmas.Derived (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
lemma-nf1*nf1 {n} nf@(s , m , ε) nf'@(s' , m' , ε) = begin
  ...
  (S^ s • M m) • (S^ s' • M m') ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ s • (M m • S^ s') • M m' ≈⟨ (cright cleft lemma-MS^k (m .proj₁) s' (m .proj₂)) ⟩
  S^ s • (S^ (s' * m ^2) • M m) • M m' ≈⟨ sym (by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto) ⟩
...
lemma-nf1*nf1 {n} nf@(s , m , ε) nf'@(s' , m' , HS^ x') = begin
  ...
  (S^ s • M m) • (S^ s' • M m' • H • S^ x' ) ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ s • (M m • S^ s') • M m' • H • S^ x' ≈⟨ (cright cleft lemma-MS^k (m .proj₁) s' (m .proj₂)) ⟩
  S^ s • (S^ (s' * m ^2) • M m) • M m' • H • S^ x' ≈⟨ sym (by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto) ⟩
...
... | ₀ | [ eq ]' =  begin
  ⟦ nf ⟧₁ • ⟦ nf' ⟧₁ ≈⟨ refl ⟩
  (S^ s • M m • H • S^ x) • (S^ s' • M m' • H • S^ x') ≈⟨ by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
...
... | (₁₊ x-1) | [ eq ]' =  begin
  ...
  (S^ s • M m • H) • (M m' • S^ ((x + s') * (m' ⁻¹) ^2)) • H • S^ x'  ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
  (S^ s • M m) • (H • M m') • S^ ((x + s') * (m' ⁻¹) ^2) • H • S^ x'  ≈⟨ ((cright (cleft semi-HM m'))) ⟩
  (S^ s • M m) • (M (m' ⁻¹) • H) • S^ ((x + s') * (m' ⁻¹) ^2) • H • S^ x'  ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  S^ s • (M m • M (m' ⁻¹)) • H • S^ ((x + s') * (m' ⁻¹) ^2) • H • S^ x'  ≈⟨ ((cright cleft axiom (M-mul m (m' ⁻¹)))) ⟩
  S^ s • M (m *' m' ⁻¹) • H • S^ ((x + s') * (m' ⁻¹) ^2) • H • S^ x'  ≈⟨ (cright by-passoc (□ ^ 5) (□ ^ 4 • □) auto) ⟩
...
aux-simp2 {n} m m' k = begin
  ...
  ⟦ m ⟧ₘ • S^ (-l⁻¹ * a) • (M (m' ⁻¹) • H) • S^ s1' ≈⟨ cright by-passoc (□  • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  ⟦ m ⟧ₘ • (S^ (-l⁻¹ * a) • M (m' ⁻¹)) • H • S^ s1' ≈⟨ cright cleft lemma-S^kM ((m' ⁻¹) .proj₁) (-l⁻¹ * a) ((m' ⁻¹) .proj₂) ⟩
  ⟦ m ⟧ₘ • (M (m' ⁻¹) • S^ (-l⁻¹ * a * ((m' ⁻¹ ⁻¹).proj₁ * (m' ⁻¹ ⁻¹).proj₁))) • H • S^ s1' ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
...
aux-simp1 {n} m m' k = begin
  M (m' ⁻¹) • H ^ 3 • S^ (l⁻¹ * a) • H • S^ k ≈⟨ cright  by-passoc (□ ^ 3 • □ ^ 3) (□ • (□ ^ 2 • □) • □ ^ 2) auto ⟩
  M (m' ⁻¹) • H • (HH • S^ (l⁻¹ * a)) • H • S^ k ≈⟨ cright cright cleft comm⇒pow-comm 1 (toℕ (l⁻¹ * a)) (trans assoc (axiom comm-HHS)) ⟩
  M (m' ⁻¹) • H • (S^ (l⁻¹ * a) • HH) • H • S^ k ≈⟨ by-passoc (□ • □ • □ ^ 3 • □ ^ 2) (□ ^ 4 • □ ^ 2 • □ ) auto ⟩
  ...
  (S^ (- mf * m'⁻¹) • M (-' m) • (H • S^ -x⁻¹)) • HH • S^ k ≈⟨ by-passoc (□ ^ 4 • □ ^ 2 • □) (□ ^ 2 • □ ^ 4 • □) auto ⟩
  (S^ (- mf * m'⁻¹) • M (-' m)) • (H • S^ -x⁻¹ • HH) • S^ k ≈⟨ cright cleft cright comm⇒pow-comm (toℕ -x⁻¹) 1 (sym (trans assoc (axiom comm-HHS))) ⟩
  (S^ (- mf * m'⁻¹) • M (-' m)) • (H • HH • S^ -x⁻¹) • S^ k ≈⟨ by-passoc (□ ^ 2 • (□ • □ ^ 2 • □) • □) (□ • □ ^ 3 • □ ^ 3) auto ⟩
...
abstract
  ...
  aux5 {n} k*@(k , nzk) l*@(l , nzl) not1 = ss , mm , kk , (begin
    H ^ 3 • S^ -kl • H • S^ -l⁻¹ • H ≈⟨ by-passoc (□ ^ 3 • □ ^ 2) ((□ ^ 2 • □ ^ 2) • □) auto ⟩
    ...
    (S^ (-x⁻¹) • M (x* ⁻¹) • (H • S^ -x⁻¹)) • S^ -l⁻¹ • H ≈⟨ by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
    (S^ (-x⁻¹) • M (x* ⁻¹) • H) • (S^ -x⁻¹ • S^ -l⁻¹) • H ≈⟨ (cright cleft lemma-S^k+l -x⁻¹ -l⁻¹) ⟩
    (S^ (-x⁻¹) • M (x* ⁻¹) • H) • S^ (-x⁻¹ + -l⁻¹) • H ≈⟨ by-passoc (□ ^ 3 • □ ^ 2) (□ ^ 5) auto ⟩
