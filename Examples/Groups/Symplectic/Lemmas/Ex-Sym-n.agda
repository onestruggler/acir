...
open import Data.Fin using (Fin ; toℕ ; suc ; fromℕ)
...
module Examples.Groups.Symplectic.Lemmas.Ex-Sym-n (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
module Lemmas0b where
  ...
  lemma-HCZHS {n} = begin
    ...
    aux2 = begin
      ...
      CZ • S ↑ ^ p-1 ≈⟨ comm⇒pow-comm 1 p-1 (axiom comm-CZ-S↑) ⟩
  ...
  lemma-HCZHS^k {n} k@(₂₊ k') = begin
    ...
    (S ↑ • S ↑ ^ (₁₊ k')) • (S ↓ • S ↓ ^ (₁₊ k')) • CZ ^ k • H ↑ • CZ • H ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 4) (□ • □ ^ 2 • □ • □ • □ ^ 3)  auto ⟩
    S ↑ • (S ↑ ^ (₁₊ k') • S ↓) • S ↓ ^ (₁₊ k') • CZ ^ k • H ↑ • CZ • H ↑ ≈⟨ (cright cleft comm⇒pow-comm (₁₊ k') 1 (axiom comm-S)) ⟩
    S ↑ • (S ↓ • S ↑ ^ (₁₊ k')) • S ↓ ^ (₁₊ k') • (CZ • CZ ^ (₁₊ k')) • H ↑ • CZ • H ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ • □ ^ 2 • □ ^ 3) (□ ^ 3 • □ ^ 2 • □ ^ 4) auto ⟩
    (S ↑ • S ↓ • S ↑ ^ (₁₊ k')) • (S ↓ ^ (₁₊ k') • CZ) • CZ ^ (₁₊ k') • H ↑ • CZ • H ↑ ≈⟨ (cright cleft comm⇒pow-comm (₁₊ k') 1 (sym (axiom comm-CZ-S↓))) ⟩
    (S ↑ • S ↓ • S ↑ ^ (₁₊ k')) • (CZ • S ↓ ^ (₁₊ k')) • CZ ^ (₁₊ k') • H ↑ • CZ • H ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 4) (□ ^ 2 • □ ^ 2 • □ ^ 5) auto ⟩
    (S ↑ • S ↓) • (S ↑ ^ (₁₊ k') • CZ) • S ↓ ^ (₁₊ k') • CZ ^ (₁₊ k') • H ↑ • CZ • H ↑ ≈⟨ (cright cleft comm⇒pow-comm (₁₊ k') 1 (sym (axiom comm-CZ-S↑))) ⟩
  ...
  lemma-XCS^k k = bbc (HH ↑) ε aux0
    ...
    aux0 = begin
      ...
      (S^ k ↑ • HH ↑) • (S^ k • CZ^ (- k) • ((H ↑) • (H ↑) • (H ↑)) • CZ • (H ↑)) ≈⟨ by-passoc (□ ^ 2 • (□ • □ • □)) (□ • □ ^ 2 • □ • □) auto ⟩
      S^ k ↑ • (HH ↑ • S^ k) • CZ^ (- k) • ((H ↑) • (H ↑) • (H ↑)) • CZ • (H ↑) ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ k) ( ((sym (lemma-comm-S-w↑ ([ H-gen ]ʷ • [ H-gen ]ʷ)))))) ⟩
  ...
  lemma-XCS^k-ℕ k = bbc (HH ↑) ε aux0
    ...
    aux0 = begin
      ...
      (HH ↑ • (S ^ k) ↑) • S ^ k • CZ ^ -k • XC ≈⟨ (cleft lemma-cong↑ _ _ (M1P.comm⇒pow-comm 1 k (M1B.trans M1B.assoc (M1B.axiom comm-HHS)))) ⟩
      ...
      aux-1 = begin
        ...
        CZ ^ (p-1 Nat.* p-1 Nat.* k) ≈⟨ sym (^^ CZ ((p-1 Nat.* p-1)) k) ⟩
        (CZ ^ (p-1 Nat.* p-1)) ^ k ≈⟨ ^-cong (CZ ^ (p-1 Nat.* p-1)) CZ k aux3 ⟩
        CZ ^ k ∎
...
-}
  ...
  lemma-comm-Ex-H' = begin
    ...
    (H ↓ • CZ • H ↓ • H ↑ • CZ • H ↓) • (CZ • CZ ^ p-1) • H ↑ • CZ ≈⟨ cright cleft comm⇒pow-comm 1 p-1 refl ⟩
    (H ↓ • CZ • H ↓ • H ↑ • CZ • H ↓) • (CZ ^ p-1 • CZ) • H ↑ • CZ ≈⟨ by-passoc (□ ^ 6 • □ ^ 2 • □ ^ 2) (□ ^ 4 • □ ^ 3 • □ ^ 3) auto ⟩
    ...
    (H • CZ • H ↓ • H ↑) • ((H ^ 3 • S⁻¹ • H) • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k) • CZ • H ↑ • CZ ≈⟨ (  by-passoc (□ ^ 4 • (□ ^ 3 • □ ^ 4) • □ ^ 3) (□ ^ 5 • □ ^ 9) auto) ⟩
    (H • CZ • H ↓ • H ↑ • H ^ 3) • S⁻¹ • H • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  cleft rewrite-sym0 100 auto) ⟩
    (H • CZ • H ↑) • S⁻¹ • H • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  by-assoc auto) ⟩
    (H • CZ) • (H ↑ • S⁻¹) • H • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  cright cleft comm⇒pow-comm 1 p-1 (axiom comm-S)) ⟩
    (H • CZ) • (S⁻¹ • H ↑) • H • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 8) (□ ^ 3 • □ ^ 2 • □ ^ 7) auto) ⟩
    (H • CZ • S⁻¹) • (H ↑ • H) • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  cright cleft axiom comm-H) ⟩
    (H • CZ • S⁻¹) • (H • H ↑) • CZ • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (  by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 7) (□ ^ 6 • □ ^ 6) auto) ⟩
    (H • CZ • S⁻¹ • H • H ↑ • CZ) • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ (cleft lemma-eqn17↓) ⟩
    (CZ • S • H  • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑) • H • S⁻¹ ^ k • S⁻¹ ↑ ^ k • CZ • H ↑ • CZ ≈⟨ by-passoc (□ ^ 8 • □ ^ 6) (□ ^ 5 • □ ^ 5 • □ ^ 2 • □ ^ 2) auto ⟩
    (CZ • S • H  • H ↑ • CZ) • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (S⁻¹ ↑ ^ k • CZ) • H ↑ • CZ ≈⟨ cong (rewrite-sym0 100 auto) (cright cleft comm⇒pow-comm k 1 (aux0)) ⟩
    (CZ • H ↑ • S • H • CZ) • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ by-passoc (□ ^ 5 • □ ^ 5 • □ ^ 2 • □ ^ 2) (□ ^ 4 • □ ^ 2 • □ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
    (CZ • H ↑ • S • H) • (CZ • S⁻¹ ↑) • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ (cright cleft sym aux0) ⟩
    (CZ • H ↑ • S • H) • (S⁻¹ ↑ • CZ) • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ by-passoc (□ ^ 4 • □ ^ 2 • □ ^ 4 • □ ^ 2 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □ •  □ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
    (CZ • H ↑ • S) • (H • S⁻¹ ↑) • CZ • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ (cright cleft lemma-comm-H-w↑ (S ^ ₁₊ p-2)) ⟩
    (CZ • H ↑ • S) • (S⁻¹ ↑ • H) • CZ • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ •  □ ^ 4 • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □ • □ • □ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
    (CZ • H ↑) • (S • S⁻¹ ↑) • H • CZ • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ (cright cleft lemma-comm-S-w↑ (S ^ ₁₊ p-2)) ⟩
    (CZ • H ↑) • (S⁻¹ ↑ • S) • H • CZ • (H ↑ • S⁻¹ ↑ • H • S⁻¹ ^ k) • (CZ • S⁻¹ ↑ ^ k) • H ↑ • CZ ≈⟨ by-passoc  (□ ^ 2 • □ ^ 2 • □ • □ • □ ^ 4 • □ ^ 2 • □ ^ 2) (□ ^ 3 • □ ^ 6 • □ ^ 2 • □ ^ 3) auto ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H ↑ • S⁻¹ ↑ • H) • (S⁻¹ ^ k • CZ) • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ (cright cright cleft comm⇒pow-comm k 1 (comm⇒pow-comm p-1 1 (sym (axiom comm-CZ-S↓)))) ⟩
    ...
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H ↑) • (H • S⁻¹ ↑) • (CZ • S⁻¹ ^ k) • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ by-passoc (□ ^ 3 • □ ^ 4 • □ ^ 2 • □ ^ 2 • □ ^ 3) (□ ^ 3 • □ ^ 4 • □ • □ ^ 2 • □ ^ 4) auto ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H ↑) • H • (S⁻¹ ↑ • CZ) • S⁻¹ ^ k • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ (cright cright cright cleft aux0) ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H ↑) • H • (CZ • S⁻¹ ↑) • S⁻¹ ^ k • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ by-passoc  (□ ^ 3 • □ ^ 4 • □ • □ ^ 2 • □ ^ 4) (□ ^ 3 • □ ^ 6 • □ ^ 5) auto ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H ↑ • H • CZ) • S⁻¹ ↑ • S⁻¹ ^ k • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ (cright cong (rewrite-sym0 100 auto) (sym assoc)) ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H • H ↑ • CZ) • (S⁻¹ ↑ • S⁻¹ ^ k) • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ (cright cright cleft comm⇒pow-comm 1 k (sym (lemma-comm-Sᵏ-w↑ (₁₊ p-2) (S ^ ₁₊ p-2)))) ⟩
    (CZ • H ↑ • S⁻¹ ↑) • (S • H • CZ • H • H ↑ • CZ) • (S⁻¹ ^ k • S⁻¹ ↑) • S⁻¹ ↑ ^ k • H ↑ • CZ ≈⟨ (cright cright by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 2 • □ ^ 2) auto) ⟩
    ...
    (CZ • H ↑ • S⁻¹ ↑) • (H • CZ • H • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑) • S • H ↑ • CZ ≈⟨ by-passoc (□ ^ 3 • □ ^ 8 • □ ^ 3) (□ ^ 2 • □ ^ 2 • □ ^ 10) auto ⟩
    (CZ • H ↑) • (S⁻¹ ↑ • H) • CZ • H • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ (cright cleft sym (lemma-comm-H-w↑ (S ^ ₁₊ p-2))) ⟩
    (CZ • H ↑) • (H • S⁻¹ ↑) • CZ • H • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 10)  (□ ^ 3 • □ ^ 2 • □ ^ 9) auto ⟩
    (CZ • H ↑ • H) • (S⁻¹ ↑ • CZ) • H • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ (cright cleft aux0) ⟩
    (CZ • H ↑ • H) • (CZ • S⁻¹ ↑) • H • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ by-passoc  (□ ^ 3 • □ ^ 2 • □ ^ 9) (□ ^ 4 • □ ^ 2 • □ ^ 8) auto ⟩
    (CZ • H ↑ • H • CZ) • (S⁻¹ ↑ • H) • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ (cright cleft sym (lemma-comm-H-w↑ (S ^ ₁₊ p-2))) ⟩
    (CZ • H ↑ • H • CZ) • (H • S⁻¹ ↑) • H ↑ • CZ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • S • H ↑ • CZ ≈⟨ by-passoc  (□ ^ 4 • □ ^ 2 • □ ^ 8) (□ ^ 5 • □ ^ 3 • □ ^ 3 • □ ^ 3) auto ⟩
    ...
    (CZ • H ↑ • H • CZ • H) • (S⁻¹ ↑ • H ↑ • CZ) • H ↑ • S ↑ • S • CZ ≈⟨ by-passoc (□ ^ 5 • □ ^ 3 • □ ^ 4) (□ ^ 5 • □ ^ 4 • □ ^ 3) auto ⟩
    (CZ • H ↑ • H • CZ • H) • (S⁻¹ ↑ • H ↑ • CZ • H ↑) • S ↑ • S • CZ ≈⟨ (cright cleft lemma-S^kHCZH' p-2) ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k • (S ^ k) ↓ • (S ^ k) ↑) • S ↑ • S • CZ ≈⟨ by-passoc (□ ^ 5 • □ ^ 6 • □ ^ 3) (□ ^ 5 • □ ^ 5 • □ ^ 2 • □ ^ 2) auto ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k • (S ^ k) ↓) • ((S ^ k) ↑ • S ↑) • S • CZ ≈⟨ (cright cright cleft lemma-cong↑ _ _ (PP1.comm⇒pow-comm k 1 (PB1.refl))) ⟩
    ...
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k • (S ^ k) ↓) • S • CZ ≈⟨ by-passoc (□ ^ 5 • □ ^ 5 • □ ^ 2) (□ ^ 5 • □ ^ 4 • □ ^ 2 • □ ) auto ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k) • ((S ^ k) ↓ • S) • CZ ≈⟨ (cright cright cleft comm⇒pow-comm k 1 refl) ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k) • (S • (S ^ k)) • CZ ≈⟨ (cright cright cleft axiom order-S) ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k) • ε • CZ ≈⟨ (cright cright left-unit) ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ k) • CZ ≈⟨ by-passoc (□ ^ 5 • □ ^ 4 • □ ^ 1) (□ ^ 5 • □ ^ 3 • □ ^ 2 ) auto ⟩
    (CZ • H ↑ • H • CZ • H) • (H ↑ • CZ • H ↑) • CZ ^ k • CZ ≈⟨ (cright cright comm⇒pow-comm k 1 refl) ⟩
    ...
    aux0 = begin
      ...
      S ↑ ^ p-1 • CZ ≈⟨ comm⇒pow-comm p-1 1 (sym (axiom comm-CZ-S↑)) ⟩
      CZ • S ↑ ^ p-1 ≈⟨ (cright refl' ( aux-↑ S p-1)) ⟩
      CZ • S⁻¹ ↑ ∎
      
    aux1 : S⁻¹ ↑ ^ p ≈ ε
    aux1 = begin
      S⁻¹ ↑ ^ p ≈⟨ ^-cong (S⁻¹ ↑) (S ↑ ^ p-1) p (refl' (Eq.sym (aux-↑ S p-1))) ⟩
      (S ↑ ^ p-1) ^ p ≈⟨ ^^' (S ↑) p-1 p ⟩
      (S ↑ ^ p) ^ p-1 ≈⟨ ^-cong (S ↑ ^ p) ((S ^ p) ↑) p-1 (refl' (aux-↑ S p)) ⟩
      (S ^ p) ↑ ^ p-1 ≈⟨ ^-cong ((S  ^ p) ↑) ε  p-1 (axiom (cong↑ order-S)) ⟩
      ε ^ p-1 ≈⟨ ε^k=ε (₁₊ p-2) ⟩
      ε ∎
  ...
  lemma-order-Ex = begin
    ...
    (H ↑  • CZ • H ↑  • H • CZ • H ↑  • H) • (H ↑ ^ 2 • CZ ^ p-1) • ((CZ • H ↑ • H • CZ • H • H ↑ • CZ) • H ↑) ≈⟨ by-passoc (□ ^ 7 • □ ^ 2 • (□ ^ 7 • □)) (□ ^ 7 • □ • □ ^ 2 • □ ^ 7) auto ⟩
    (H ↑  • CZ • H ↑  • H • CZ • H ↑  • H) • (H ↑ ^ 2) • (CZ ^ p-1 • CZ) • H ↑ • H • CZ • H • H ↑ • CZ • H ↑ ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
    ...
    (H ↑  • CZ • H ↑  • H) • (H ^ 2 • CZ ^ p-1) • CZ • H • H ↑ • CZ • H ↑ ≈⟨ by-passoc (□ ^ 4 • □ ^ 2 • □ ^ 5) (□ ^ 4 • □ • □ ^ 2 • □ ^ 4) auto ⟩
    (H ↑  • CZ • H ↑  • H) • H ^ 2 • (CZ ^ p-1 • CZ) • H • H ↑ • CZ • H ↑ ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
    ...
    H ↑ • (H ↑ ^ 2 • CZ^ ₋₁) • CZ • H ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2) (□ • □ • □ ^ 2 • □) auto ⟩
    H ↑ • H ↑ ^ 2 • (CZ^ ₋₁ • CZ) • H ↑ ≈⟨ (cright cright cleft cleft refl' (Eq.cong (CZ ^_) (lemma-toℕ₋₁ {p-1})))⟩
    H ↑ • H ↑ ^ 2 • (CZ ^ p-1 • CZ) • H ↑ ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
  ...
  lemma-CZCZ^aHCZ^k (a@(₁₊ a-1)) k nzk = begin
    CZ ^ j • H • CZ^ k ≈⟨ refl ⟩
    (CZ • CZ ^ a) • H • CZ^ k ≈⟨ (cleft comm⇒pow-comm 1 a refl) ⟩
    ...
    CZ ^ a • ((S^ -k⁻¹ • H • S^ -k) • M k* ) • CZ • H • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc (□ • (□ ^ 3 • □) • □ ^ 4) (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 3) auto ⟩
    (CZ ^ a • S^ -k⁻¹) • (H • S^ -k) • (M k* • CZ) • H • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ cong (comm⇒pow-comm a (toℕ -k⁻¹) (axiom comm-CZ-S↓)) (cright cleft axiom (semi-M↓CZ k*)) ⟩
    (S^ -k⁻¹ • CZ ^ a) • (H • S^ -k) • (CZ^ k • M k*) • H • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 3) (□ ^ 3 • □ ^ 2 • □ ^ 4) auto ⟩
    (S^ -k⁻¹ • CZ ^ a • H) • (S^ -k • CZ^ k) • M k* • H • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ (cright cleft comm⇒pow-comm (toℕ -k) (toℕ k) (sym (axiom comm-CZ-S↓))) ⟩
    (S^ -k⁻¹ • CZ ^ a • H) • (CZ^ k • S^ -k) • M k* • H • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc  (□ ^ 3 • □ ^ 2 • □ ^ 4) (□ • □ ^ 3 • □ • □ ^ 2 • □ ^ 2) auto ⟩
    S^ -k⁻¹ • (CZ ^ a • H • CZ^ k) • S^ -k • (M k* • H) • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ (cright cright cright cleft sym (semi-HM' k*)) ⟩
    S^ -k⁻¹ • (CZ ^ a • H • CZ^ k) • S^ -k • (H • M (k* ⁻¹)) • S⁻¹ ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc (□ • □ ^ 3 • □ • □ ^ 2 • □ ^ 2) ((□ • □ ^ 3 • □ ^ 2) • □ ^ 2 • □) auto ⟩
    (S^ -k⁻¹ • (CZ ^ a • H • CZ^ k) • S^ -k • H) • (M (k* ⁻¹) • S⁻¹ ^ k') • S⁻¹ ↑ ^ k' ≈⟨ (cright cleft aux1) ⟩
    (S^ -k⁻¹ • (CZ ^ a • H • CZ^ k) • S^ -k • H) • (S^ -k⁻¹ • M (k* ⁻¹)) • S⁻¹ ↑ ^ k' ≈⟨ by-passoc ((□ • □ ^ 3 • □ ^ 2) • □ ^ 2 • □) (□ ^ 4 • (□ ^ 3 • □) • □) auto ⟩
    ...
    (S^ -k⁻¹ • (S^ -k⁻¹) ^ a-1 • (CZ • H • CZ^ k) • (H ^ 3 • (S^ k⁻¹) ^ a-1 • H) • ((S^ -k) ^ a-1) ↑) • (H ^ 3 • S^ k⁻¹ • H) • (S^ -k) ↑ ≈⟨ by-passoc (□ ^ 5 • □ ^ 2) (□ ^ 2 • □ • □ • □ ^ 2 • □) auto ⟩
    (S^ -k⁻¹ • (S^ -k⁻¹) ^ a-1) • (CZ • H • CZ^ k) • (H ^ 3 • (S^ k⁻¹) ^ a-1 • H) • ((S^ -k ^ a-1) ↑ • (H ^ 3 • S^ k⁻¹ • H)) • (S^ -k) ↑ ≈⟨ cong (aux-ww^k (S^ -k⁻¹) a-1) (cright cright cleft aux2') ⟩
    (S^ -k⁻¹) ^ a • (CZ • H • CZ^ k) • (H ^ 3 • (S^ k⁻¹) ^ a-1 • H) • ((H ^ 3 • S^ k⁻¹ • H) • (S^ -k ^ a-1) ↑) • (S^ -k) ↑ ≈⟨ (cright cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    (S^ -k⁻¹) ^ a • (CZ • H • CZ^ k) • ((H ^ 3 • (S^ k⁻¹) ^ a-1 • H) • (H ^ 3 • S^ k⁻¹ • H)) • (S^ -k ^ a-1) ↑ • (S^ -k) ↑ ≈⟨ (cright cright cong (by-passoc (□ ^ 3 • □ ^ 3) (□ • □ • □ ^ 2 • □ ^ 2) auto) (lemma-cong↑ _ _ (PP1.comm⇒pow-comm a-1 (toℕ -k) (PP1.comm⇒pow-comm (toℕ -k) 1 PB1.refl)))) ⟩
    ...
    (S^ -k⁻¹) ^ a • (CZ • H • CZ^ k) • (H ^ 3 • (S^ k⁻¹ ^ a-1 • S^ k⁻¹) • H) • (S^ -k ^ a) ↑ ≈⟨ (cright cright cleft cright cleft comm⇒pow-comm a-1 (toℕ k⁻¹) (comm⇒pow-comm (toℕ k⁻¹) 1 refl)) ⟩
    ...
    aux2' = begin
      ...
      (H ^ 3 • ((S^ -k) ^ a-1) ↑) • S^ k⁻¹ • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
      ...
      H ^ 3 • S^ k⁻¹ • H • ((S^ -k) ^ a-1) ↑ ≈⟨ by-passoc (□ ^ 4 ) (□ ^ 3 • □) auto ⟩
      (H ^ 3 • S^ k⁻¹ • H) • ((S^ -k) ^ a-1) ↑ ∎
  ...
  lemma-CZCZ^aHCZ^k' a k nzk = 
    ...
    in sym (begin
      ...
      (S^ -k⁻¹ ^ j • H) • (S^ -k • S^ k) • CZ^ k • H ^ 3 • (S^ k⁻¹ ^ j) • H • (S^ -k ^ j) ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
      (S^ -k⁻¹ ^ j • H • S^ -k) • (S^ k • CZ^ k) • H ^ 3 • (S^ k⁻¹ ^ j) • H • (S^ -k ^ j) ↑ ≈⟨ (cright cleft comm⇒pow-comm (toℕ k) (toℕ k) (sym (axiom comm-CZ-S↓))) ⟩
      (S^ -k⁻¹ ^ j • H • S^ -k) • (CZ^ k • S^ k) • H ^ 3 • (S^ k⁻¹ ^ j) • H • (S^ -k ^ j) ↑ ≈⟨ (cright by-passoc (□ ^ 2 • □ ^ 4) (□ • □ ^ 2 • □ ^ 3) auto) ⟩
      ...
      (S^ -k⁻¹ ^ j • H • S^ -k) • (CZ^ k • M₁) • (S^ k • H ^ 3) • (S^  k⁻¹ • S^ k⁻¹ ^ a) • H • (S^ -k ^ j) ↑ ≈⟨ (cright cright by-passoc (□ ^ 2 • □ ^ 2 • □ ) (□ ^ 3 • □ ^ 2) auto) ⟩
      ...
      (S^ -k⁻¹ ^ j • H • S^ (- k)) • (CZ^ k • M k* • M (-' b' ⁻¹)) • (S^ (- b) • H ^ 3 • S^ (-b⁻¹)) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ (cright by-passoc (□ ^ 3 • □ ^ 3 • □) (□ ^ 2 • □ ^ 4 • □) auto) ⟩
      ...
      (S^ -k⁻¹ ^ j • H • S^ (- k)) • (M k* • CZ) • (H • S^ -k • H ^ 3) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 6 ) auto ⟩
      (S^ -k⁻¹ ^ j) • H • S^ (- k) • M k* • CZ • (H • S^ -k • H ^ 3) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ (cleft sym (aux-ww^k (S^ -k⁻¹) a)) ⟩
      (S^ -k⁻¹ • S^ -k⁻¹ ^ a) • H • S^ (- k) • M k* • CZ • (H • S^ -k • H ^ 3) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ (cleft comm⇒pow-comm 1 a refl) ⟩
      (S^ -k⁻¹ ^ a • S^ -k⁻¹) • H • S^ (- k) • M k* • CZ • (H • S^ -k • H ^ 3) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 8) (□ • (□ ^ 3 • □) • □ ^ 5) auto ⟩
      (S^ -k⁻¹) ^ a • ((S^ -k⁻¹ • H • S^ (- k)) • M k*) • CZ • (H • S^ -k • H ^ 3) • S^ k⁻¹ ^ a • H • (S^ -k ^ j) ↑ ≈⟨ (cright by-passoc (□ ^ 2 • □ • □ ^ 3 • □ ^ 3) ((□ ^ 2 • □ ^ 3) • □ ^ 3 • □) auto) ⟩
      ...
      (S^ -k⁻¹) ^ a • ((H ^ 3 • S ^ k' • H) • CZ • H • S⁻¹ ^ k') • (S⁻¹ ↑ ^ k' • (H ^ 3 • S^ k⁻¹ ^ a • H)) • (S^ -k ^ a) ↑ ≈⟨ (cright by-passoc (□ ^ 4 • □ ^ 2 • □) (□ ^ 5 • □ ^ 2) auto) ⟩
    ...
    aux2' = begin
      ...
      (H ^ 3 • ((S^ -k)) ↑) • S^ k⁻¹ ^ a • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
      H ^ 3 • (((S^ -k)) ↑ • S^ k⁻¹ ^ a) • H ≈⟨ (cright cleft (cright ^^ S (toℕ k⁻¹) a)) ⟩
      H ^ 3 • (((S^ -k)) ↑ • S ^ (toℕ k⁻¹ Nat.* a)) • H ≈⟨ (cright cleft sym (lemma-comm-Sᵏ-w↑ ((toℕ k⁻¹ Nat.* a)) (S^ -k))) ⟩
      H ^ 3 • (S ^ (toℕ k⁻¹ Nat.* a) • S^ -k ↑) • H ≈⟨ (cright cleft (cleft sym (^^ S (toℕ k⁻¹) a))) ⟩
      H ^ 3 • (S^ k⁻¹ ^ a • ((S^ -k)) ↑) • H ≈⟨ (cright assoc) ⟩
      H ^ 3 • S^ k⁻¹ ^ a • ((S^ -k)) ↑ • H ≈⟨ (cright cright sym (lemma-comm-H-w↑ (S^ -k))) ⟩
      H ^ 3 • S^ k⁻¹ ^ a • H • ((S^ -k)) ↑ ≈⟨ by-passoc (□ ^ 4 ) (□ ^ 3 • □) auto ⟩
      (H ^ 3 • S^ k⁻¹ ^ a • H) • ((S^ -k)) ↑ ∎
  ...
  abstract
    ...
    lemma-CZCZ^aH³CZ^k' a k nzk = 
      begin
        ...
        CZ ^ j • H • CZ^ -k • H ^ 2 ≈⟨ by-passoc (□ ^ 4) (□ ^ 3 • □) auto ⟩
        (CZ ^ j • H • CZ^ -k) • H ^ 2 ≈⟨ (cleft lemma-CZCZ^aHCZ^k' a (- k) ((-' k*) .proj₂)) ⟩
        (S^ -k⁻¹' ^ j • H • CZ^ k' • H ^ 3 • S^ k⁻¹' ^ j • H • (S^ -k' ^ j) ↑) • H ^ 2 ≈⟨ by-passoc (□ ^ 7 • □) (□ ^ 6 • □ ^ 2) auto ⟩
        (S^ -k⁻¹' ^ j • H • CZ^ k' • H ^ 3 • S^ k⁻¹' ^ j • H) • (S^ -k' ^ j) ↑ • H ^ 2 ≈⟨ (cright sym (lemma-comm-Hᵏ-w↑ 2 ((S^ -k' ^ j)))) ⟩
        (S^ -k⁻¹' ^ j • H • CZ^ k' • H ^ 3 • S^ k⁻¹' ^ j • H) • H ^ 2 • (S^ -k' ^ j) ↑ ≈⟨ (cleft (cright cright cright by-passoc (□ ^ 3 • □ ^ 2) (□ • (□ ^ 2 • □) • □) auto)) ⟩
        (S^ -k⁻¹' ^ j • H • CZ^ k' • H • (H ^ 2 • S^ k⁻¹' ^ j) • H) • H ^ 2 • (S^ -k' ^ j) ↑ ≈⟨ (cleft (cright cright cright  (cright (cleft comm⇒pow-comm 1 j (comm⇒pow-comm 1 (toℕ k⁻¹') (trans assoc (axiom comm-HHS))))))) ⟩
        (S^ -k⁻¹' ^ j • H • CZ^ k' • H • (S^ k⁻¹' ^ j • H ^ 2) • H) • H ^ 2 • (S^ -k' ^ j) ↑ ≈⟨ by-passoc ((□ • □ • □ • □ • □ ^ 2 • □) • □ ^ 2) (□ ^ 5 • □ ^ 4) auto ⟩
...
module Lemmas3 where
  ...
  lemma-comm-Ex-w↑↑ {n} [ H-gen ]ʷ = rewrite-sym (₁₊ n) 1000 auto
  lemma-comm-Ex-w↑↑ {n} [ S-gen ]ʷ = rewrite-sym (₁₊ n) 1000 auto
  lemma-comm-Ex-w↑↑ {n} [ CZ-gen ]ʷ = rewrite-sym (₁₊ n) 1000 auto
