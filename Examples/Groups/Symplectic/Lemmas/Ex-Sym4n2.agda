...
module Examples.Groups.Symplectic.Lemmas.Ex-Sym4n2 (p-2 : ℕ) (p-prime : Prime (2+ p-2)) (n : ℕ)  where
...
lemma-Ex-M-n m@x' = begin
  ...
  (S^ x ↑ • Ex) • H • S^ x⁻¹ • H • S^ x • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ x ↑ • (Ex • H) • S^ x⁻¹ • H • S^ x • H ≈⟨ cright cleft sym lemma-comm-Ex-H-n ⟩
  S^ x ↑ • (H ↑ • Ex) • S^ x⁻¹ • H • S^ x • H ≈⟨ cright by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ x ↑ • H ↑ • (Ex • S^ x⁻¹) • H • S^ x • H ≈⟨ cright cright cleft lemma-Ex-S^ᵏ ((m ⁻¹) .proj₁) ⟩
  S^ x ↑ • H ↑ • (S^ x⁻¹ ↑ • Ex) • H • S^ x • H ≈⟨ cright cright by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  S^ x ↑ • H ↑ • S^ x⁻¹ ↑ • (Ex • H) • S^ x • H ≈⟨ cright cright cright cleft sym lemma-comm-Ex-H-n ⟩
  S^ x ↑ • H ↑ • S^ x⁻¹ ↑ • (H ↑ • Ex) • S^ x • H ≈⟨ cright cright cright by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto  ⟩
  ...
  S^ x ↑ • H ↑ • S^ x⁻¹ ↑ • H ↑ • S^ x ↑ • H ↑ • Ex ≈⟨ by-passoc (□ ^ 7) (□ ^ 6 • □) auto ⟩
  M m ↑ • Ex ∎
    where
    x = x' .proj₁
    x⁻¹ = ((x' ⁻¹) .proj₁ )
...
aux-Ex1 = begin
  ...
  ((H ↓ • H ↑ • CZ • H ↓ • H ↑ • CZ • H ↓ • H ↑) • CZ) • CZ^ ₋₁ • H^ ₃ ↑ • H^ ₃ • CZ^ ₋₁ • H ↑ ^ 3 • H ^ 3 ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
...
lemma-CZ^-pred k*@(₁₊ k , nzk) = begin
  ...
  CZ • CZ ^ (toℕ k) ≈⟨ comm⇒pow-comm 1 (toℕ k) refl ⟩
...
aux-hEx' = bbc (H • H ↑ • CZ • H • H ↑) ε aux
  ...
  aux = begin
    ...
    (H • H ↑) • (CZ • CZ⁻¹) • H ↑ ^ 3 • H ^ 3 • Ex ≈⟨  by-passoc (□ ^ 2 • □ ^ 2 • □) (□ ^ 3 • □ ^ 2) auto ⟩
...
aux-hEx = begin
  ...
  (HH ↑ • CZ^ (₋₁)) • (HH • H ↑) • H • CZ • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^ 2 • □ ^ 2) auto ⟩
...
lemma-Ex-M'-n m = bbc Ex Ex claim
  ...
  claim = begin
    Ex • (Ex • (M m ↑)) • Ex ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex) • M m ↑ • Ex ≈⟨ cleft lemma-order-Ex-n ⟩
    ε • M m ↑ • Ex ≈⟨ left-unit ⟩
    M m ↑ • Ex ≈⟨ sym (lemma-Ex-M-n m) ⟩
    (Ex • M m) ≈⟨ sym right-unit ⟩
    (Ex • M m) • ε ≈⟨ cright sym lemma-order-Ex-n ⟩
    (Ex • M m) • Ex • Ex ≈⟨ sym (by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    Ex • (M m • Ex) • Ex ∎
...
lemma-Ex-S^ᵏ↑ k = bbc Ex Ex claim
  where
  claim : Ex • (Ex • (S^ k ↑)) • Ex ≈ Ex • (S^ k • Ex) • Ex
  claim = begin
    Ex • (Ex • (S^ k ↑)) • Ex ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex) • S^ k ↑ • Ex ≈⟨ cleft lemma-order-Ex-n ⟩
    ε • S^ k ↑ • Ex ≈⟨ left-unit ⟩
    S^ k ↑ • Ex ≈⟨ sym (lemma-Ex-S^ᵏ k) ⟩
    (Ex • S^ k) ≈⟨ sym right-unit ⟩
    (Ex • S^ k) • ε ≈⟨ cright sym lemma-order-Ex-n ⟩
...
lemma-Ex-C c@(HS^ k) = begin
  Ex • ⟦ c ⟧ₕₛ ≈⟨ sym assoc ⟩
  (Ex • H) • S^ k ≈⟨ cleft sym lemma-comm-Ex-H-n  ⟩
  (H ↑ • Ex) • S^ k ≈⟨ assoc ⟩
...
lemma-Ex-SMC↑ nf1 = bbc Ex Ex claim
  ...
  claim = begin
    Ex • (Ex • ⟦ nf1 ⟧₁) • Ex ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex) • ⟦ nf1 ⟧₁ • Ex ≈⟨ trans (cleft lemma-order-Ex-n) left-unit ⟩
    ⟦ nf1 ⟧₁ • Ex ≈⟨ sym (lemma-Ex-SMC nf1) ⟩
    Ex • ⟦ nf1 ⟧₁ ↑ ≈⟨ sym (trans (cright lemma-order-Ex-n) right-unit) ⟩
    (Ex • ⟦ nf1 ⟧₁ ↑) • Ex • Ex ≈⟨ sym (by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    Ex • (⟦ nf1 ⟧₁ ↑ • Ex) • Ex ∎
...
aux-hEx'' = begin
  ...
  H ↑ ^ 3 • H ^ 3 • CZ^ ₋₁ • H ↑ ^ 3 • H ^ 3 • Ex ≈⟨ by-passoc (□ • □ ^ 3 • □ ^ 4) (□ • □ • (□ ^ 2 • □) • □ ^ 3) auto ⟩
  H ↑ ^ 3 • H • (HH • CZ^ ₋₁) • H ↑ ^ 3 • H ^ 3 • Ex ≈⟨ cright cright cleft sym lemma-semi-CZ-HH↓ ⟩
  H ↑ ^ 3 • H • (CZ^ ₁ • HH) • H ↑ ^ 3 • H ^ 3 • Ex ≈⟨ by-passoc (□ • □ • □ ^ 2 • □ ^ 3) (□ ^ 3 • □ ^ 4) auto ⟩
  (H ↑ ^ 3 • H • CZ^ ₁) • HH • H ↑ ^ 3 • H ^ 3 • Ex ≈⟨ cright rewrite-sym0 100 auto ⟩
  (H ↑ ^ 3 • H • CZ^ ₁) • HH ↑ • H ↑ • H • Ex ≈⟨ by-passoc (□ ^ 3 • □ ^ 4) (□ ^ 2 • □ ^ 2 • □ ^ 3) auto ⟩
  (H ↑ ^ 3 • H) • (CZ^ ₁ • HH ↑) • H ↑ • H • Ex ≈⟨ cright cleft lemma-semi-CZ-HH↑ ⟩
  (H ↑ ^ 3 • H) • (HH ↑ • CZ^ ₋₁) • H ↑ • H • Ex ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 3) (□ ^ 3 • □ ^ 4) auto ⟩
...
aux-hh|hh-ex : (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈ Ex • (H ↑ • H • CZ⁻¹ • H ↑ • H)
aux-hh|hh-ex = begin
  (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈⟨ by-passoc (□ ^ 5 • □) (□ ^ 4 • □ ^ 2) auto ⟩
  (H • H ↑ • CZ⁻¹ • H) • H ↑ • Ex ≈⟨ cright lemma-comm-Ex-H-n ⟩
  (H • H ↑ • CZ⁻¹ • H) • Ex • H ≈⟨ by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
  (H • H ↑ • CZ⁻¹) • (H • Ex) • H ≈⟨ cright cleft lemma-comm-Ex-H↑ ⟩
  (H • H ↑ • CZ⁻¹) • (Ex • H ↑) • H ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
  (H • H ↑) • (CZ⁻¹ • Ex) • H ↑ • H ≈⟨ cright cleft comm⇒pow-comm p-1 1 lemma-comm-Ex-CZ-n ⟩
  (H • H ↑) • (Ex • CZ⁻¹) • H ↑ • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  H • (H ↑ • Ex) • CZ⁻¹ • H ↑ • H ≈⟨ cright cleft lemma-comm-Ex-H-n ⟩
  H • (Ex • H) • CZ⁻¹ • H ↑ • H ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  (H • Ex) • H • CZ⁻¹ • H ↑ • H ≈⟨ cleft lemma-comm-Ex-H↑ ⟩
  (Ex • H ↑) • H • CZ⁻¹ • H ↑ • H ≈⟨ assoc ⟩
  Ex • (H ↑ • H • CZ⁻¹ • H ↑ • H) ∎
...
aux-hEx''' = trans aux-hEx'' (sym (bbc Ex Ex claim))
  where
  claim : Ex • (Ex • (H  • H ↑ • CZ⁻¹ • H • H ↑)) • Ex ≈ Ex • (H ↑ • H • CZ⁻¹ • H ↑ • H • Ex) • Ex
  claim = begin
    Ex • (Ex • (H • H ↑ • CZ⁻¹ • H • H ↑)) • Ex ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex) • (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈⟨ cleft lemma-order-Ex-n ⟩
    ε • (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈⟨ left-unit ⟩
    (H • H ↑ • CZ⁻¹ • H • H ↑) • Ex ≈⟨ ( aux-hh|hh-ex) ⟩
    (Ex • ( H ↑ • H • CZ⁻¹ • H ↑ • H)) ≈⟨ sym right-unit ⟩
    (Ex • ( H ↑ • H • CZ⁻¹ • H ↑ • H)) • ε ≈⟨ cright sym lemma-order-Ex-n ⟩
    (Ex • ( H ↑ • H • CZ⁻¹ • H ↑ • H)) • Ex • Ex ≈⟨ sym (by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    Ex • (( H ↑ • H • CZ⁻¹ • H ↑ • H) • Ex) • Ex ≈⟨ cright cleft by-passoc (□ ^ 5 • □) (□ ^ 6 ) auto ⟩
    Ex • (H ↑ • H • CZ⁻¹ • H ↑ • H • Ex) • Ex ∎
