...
module Examples.Groups.Symplectic.Lemmas.Ex-Sym1 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
module Lemmas0a1 where
  ...
  lemma-selinger-c11 {n} = begin 
    ...
    S⁻¹ • H • S⁻¹ • CZ • H • S⁻¹ • S⁻¹ ↑ ≈⟨ by-passoc (□ ^ 7) (□ ^ 2 • □ ^ 2 • □ ^ 3) auto ⟩
    (S⁻¹ • H) • (S⁻¹ • CZ) • H • S⁻¹ • S⁻¹ ↑ ≈⟨ (cright cleft comm⇒pow-comm p-1 1 (sym (axiom comm-CZ-S↓))) ⟩
    (S⁻¹ • H) • (CZ • S⁻¹) • H • S⁻¹ • S⁻¹ ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 3) (□ • □ • □ • □ ^ 3 • □) auto ⟩
    S⁻¹ • H • CZ • (S⁻¹ • H • S⁻¹) • S⁻¹ ↑ ∎
    where
    open PB ((₂₊ n) QRel,_===_)
    open PP ((₂₊ n) QRel,_===_)
  ...
  lemma-CZ^kHCZ {n} k'@(₁₊ k'') = let k = ₁₊ k' in begin
    ...
    (CZ • S⁻¹ ^ k') • H • CZ • (S⁻¹ • H • S⁻¹) ^ k' • S⁻¹ ↑ ^ k' ≈⟨ (cleft comm⇒pow-comm 1 k' (comm⇒pow-comm 1 p-1 (axiom comm-CZ-S↓))) ⟩
    (S⁻¹ ^ k' • CZ) • H • CZ • (S⁻¹ • H • S⁻¹) ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc (□ ^ 2 • □ • □ • □) (□ • □ ^ 3 • □) auto ⟩
    S⁻¹ ^ k' • (CZ • H • CZ) • (S⁻¹ • H • S⁻¹) ^ k' • S⁻¹ ↑ ^ k' ≈⟨ (cright cleft lemma-selinger-c11) ⟩
    S⁻¹ ^ k' • (S⁻¹ • H • CZ • (S⁻¹ • H • S⁻¹) • S⁻¹ ↑) • (S⁻¹ • H • S⁻¹) ^ k' • S⁻¹ ↑ ^ k' ≈⟨ by-passoc (□ • □ ^ 5 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □ • □ ^ 2 • □) auto ⟩
    (S⁻¹ ^ k' • S⁻¹) • (H • CZ) • (S⁻¹ • H • S⁻¹) • (S⁻¹ ↑ • (S⁻¹ • H • S⁻¹) ^ k') • S⁻¹ ↑ ^ k' ≈⟨ cong (comm⇒pow-comm k' p-1 (comm⇒pow-comm p-1 1 refl)) (cright cright cleft comm⇒pow-comm 1 k' aux) ⟩
    (S⁻¹ • S⁻¹ ^ k') • (H • CZ) • (S⁻¹ • H • S⁻¹) • ((S⁻¹ • H • S⁻¹) ^ k' • S⁻¹ ↑) • S⁻¹ ↑ ^ k' ≈⟨ by-passoc ((□ ^ 2 • □ ^ 2 • □ • □ ^ 2 • □)) (□ ^ 2 • □ • □ • □ ^ 2 • □ ^ 2) auto ⟩
  ...
  lemma-Euler {n} b' = begin    
    ...
    (S^ -b⁻¹ • H ^ 3) • (S^ (- b) • S^ b) • H • S^ b⁻¹ • H • S^ b • H ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ) (□ ^ 3 • □ • □) auto ⟩
  ...
  lemma-Euler' {n} b' = begin
    ...
    H ^ 2 • (S^ -b⁻¹ • H ^ 3 • S^ (- b)) • M b' ≈⟨ by-passoc (□ • □ ^ 3 • □) (□ ^ 2 • □ ^ 3) auto ⟩
    (H ^ 2 • S^ -b⁻¹) • H ^ 3 • S^ (- b) • M b' ≈⟨ (cleft comm⇒pow-comm 1 (toℕ -b⁻¹) (trans assoc (axiom comm-HHS))) ⟩
    (S^ -b⁻¹ • H ^ 2) • H ^ 3 • S^ (- b) • M b' ≈⟨ by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 2 • □ ^ 2) auto ⟩
  ...
  lemma-Euler-v2 {n} b' = begin
    ...
    H ^ 2 • (S^ -b⁻¹ • H • S^ (- b)) • M b' ≈⟨ by-passoc (□ • □ ^ 3 • □) (□ ^ 2 • □ ^ 3) auto ⟩
    (H ^ 2 • S^ -b⁻¹) • H • S^ (- b) • M b' ≈⟨ (cleft comm⇒pow-comm 1 (toℕ -b⁻¹) (trans assoc (axiom comm-HHS))) ⟩
    (S^ -b⁻¹ • H ^ 2) • H • S^ (- b) • M b' ≈⟨ by-passoc (□ ^ 3 • □ ^ 3) (□ ^ 2 • (□ ^ 2 • □) • □) auto ⟩
    (S^ -b⁻¹ • H) • (H ^ 2 • S^ (- b)) • M b' ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ (- b)) (trans assoc (axiom comm-HHS))) ⟩
    ...
    (S^ -b⁻¹ • H) • S^ (- b) • M (-' b') ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ ^ 3 • □) auto ⟩
    (S^ -b⁻¹ • H • S^ (- b)) • M (-' b') ∎
    where
    open PB ((₂₊ n) QRel,_===_)
    open PP ((₂₊ n) QRel,_===_)
  ...
  lemma-Euler′ {n} b' = begin
    ...
    (S^ -b⁻¹ • H ^ 3 • S^ -b) • M (-' b') • H ^ 2 ≈⟨ by-passoc (□ ^ 3 • □ ^ 2) (□ ^ 4 • □) auto ⟩
    (S^ -b⁻¹ • H ^ 3 • S^ -b • M (-' b')) • H ^ 2 ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
    S^ (-b⁻¹) • H ^ 3 • S^ -b • M (-' b') • H ^ 2 ≈⟨ (cright cright (cright sym (aux-comm-HH-M (-' b')))) ⟩
    S^ (-b⁻¹) • H ^ 3 • S^ -b • H ^ 2 • M (-' b') ≈⟨ (cright cright sym assoc) ⟩
    S^ (-b⁻¹) • H ^ 3 • (S^ -b • H ^ 2) • M (-' b') ≈⟨ (cright cright cleft comm⇒pow-comm (toℕ -b) 1 (sym (trans assoc (axiom comm-HHS)))) ⟩
    ...
    S^ (-b * (-b⁻¹ * -b⁻¹)) • (M (-' (b' ⁻¹)) • H) • S^ (-b⁻¹) ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  ...
  lemma-Euler′' {n} b' = begin
    ...
    M (-' b' ⁻¹) • S^ (- b) • H • S^ (-b⁻¹) • H ^ 2 ≈⟨ (cright cright cright comm⇒pow-comm (toℕ -b⁻¹) 1 (sym (trans assoc (axiom comm-HHS)))) ⟩
  ...
  lemma-Euler-Mˡ {n} b' = begin
    ...
    M (-' b' ⁻¹) • (S^ (- b) • H ^ 3 • S^ (-b⁻¹)) ≈⟨ (cright by-passoc (□ • □ ^ 3 • □) (□ ^ 3 • □ ^ 2) auto) ⟩
    M (-' b' ⁻¹) • ((S^ (- b) • H ^ 2) • H • S^ (-b⁻¹)) ≈⟨ (cright cleft comm⇒pow-comm (toℕ (-b)) 1 (sym (trans assoc (axiom comm-HHS)))) ⟩
    M (-' b' ⁻¹) • ((H ^ 2 • S^ (- b)) • H • S^ (-b⁻¹)) ≈⟨ by-passoc (□ • ((□ ^ 2 • □) • □)) (□ ^ 3 • □ ^ 2) auto ⟩
  ...
  lemma-Euler-Mˡ' {n} b' = begin
    H ^ 3 • S^ b • H ≈⟨ by-assoc auto ⟩
    H • (H ^ 2 • S^ b) • H ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ b) (trans assoc (axiom comm-HHS))) ⟩
  ...
  aux--2k-2k' {n} k = begin
    ...
    S ^ ((toℕ -k' Nat.% p Nat.+ toℕ -k' Nat.% p)) ≈⟨ ^-+ S (toℕ -k' Nat.% p) (toℕ -k' Nat.% p) ⟩
