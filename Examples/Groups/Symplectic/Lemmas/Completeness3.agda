...
module Examples.Groups.Symplectic.Lemmas.Completeness3 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.Lemmas.Ex-Sym4n3 p-2 p-prime as Sym4n3 hiding (module P1)
