...
aux-comm-SMCMC : ∀ mc nf1 -> ⟦ mc ⟧ₘ₊ ↑ • ⟦ nf1 ⟧₁ ≈ ⟦ nf1 ⟧₁ • ⟦ mc ⟧ₘ₊ ↑
aux-comm-SMCMC mc@(m , c) nf1@(s' , m' , c') = begin
  ⟦ m , c ⟧ₘ₊ ↑ • ⟦ s' , m' , c' ⟧₁ ≈⟨ sym assoc ⟩
  (⟦ m , c ⟧ₘ₊ ↑ • S^ s') • ⟦ m' , c' ⟧ₘ₊  ≈⟨ cleft sym (lemma-comm-Sᵏ-w↑ (toℕ s') ⟦ m , c ⟧ₘ₊) ⟩
  (S^ s' • ⟦ m , c ⟧ₘ₊ ↑) • ⟦ m' , c' ⟧ₘ₊  ≈⟨ assoc ⟩
  S^ s' • ⟦ m , c ⟧ₘ₊ ↑ • ⟦ m' , c' ⟧ₘ₊  ≈⟨ cright sym (aux-comm-MCMC m' c' m c) ⟩
  S^ s' • ⟦ m' , c' ⟧ₘ₊ • ⟦ m , c ⟧ₘ₊ ↑ ≈⟨ sym assoc ⟩
  ⟦ s' , m' , c' ⟧₁ • ⟦ m , c ⟧ₘ₊ ↑ ∎


aux-comm-SMCM : ∀ m nf1 -> ⟦ m ⟧ₘ ↑ • ⟦ nf1 ⟧₁ ≈ ⟦ nf1 ⟧₁ • ⟦ m ⟧ₘ ↑
aux-comm-SMCM m nf1@(s' , m' , c') = begin
  ⟦ m ⟧ₘ ↑ • ⟦ s' , m' , c' ⟧₁ ≈⟨ cleft sym right-unit ⟩
  ⟦ m , ε ⟧ₘ₊ ↑ • ⟦ s' , m' , c' ⟧₁ ≈⟨ aux-comm-SMCMC (m , ε) nf1 ⟩
  ⟦ s' , m' , c' ⟧₁ • ⟦ m , ε ⟧ₘ₊ ↑ ≈⟨ cright right-unit ⟩
  ⟦ s' , m' , c' ⟧₁ • ⟦ m ⟧ₘ ↑ ∎
