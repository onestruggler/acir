...
lemma-HCZHS-dual {n} = begin
  ...
  aux1 : S⁻¹ ↑ • S ↑ ≈ ε
  aux1 = begin
    S⁻¹ ↑ • S ↑ ≈⟨ lemma-cong↑ _ _ (M1P.comm⇒pow-comm p-1 1 M1B.refl) ⟩
    (S ^ p) ↑ ≈⟨ lemma-cong↑ _ _  (M1B.axiom order-S) ⟩
    ε ∎
...
lemma-CZH↓CZ^k {n} k'@0 = let k = ₁₊ k' in begin
  ...
  S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓ • S⁻¹ ↓ • S⁻¹ ↑ ≈⟨ by-passoc (□ ^ 7) (□ ^ 3 • □ ^ 4) auto ⟩
...
lemma-CZH↓CZ^k {n} k'@(₁₊ k'') = begin
  CZ • H ↓ • CZ ^ k ≈⟨ by-passoc (□ ^ 4) (□ ^ 3 • □) auto ⟩
  (CZ • H ↓ • CZ) • CZ ^ k' ≈⟨ (cleft lemma-CZH↓CZ^k 0) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓ • S⁻¹ ↓ • S⁻¹ ↑) • CZ ^ k' ≈⟨ by-passoc (□ ^ 5 • □) (□ ^ 4 • □ ^ 2) auto ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓ • S⁻¹ ↓) • S⁻¹ ↑ • CZ ^ k' ≈⟨ (cright cleft sym (refl' (lemma-^-↑ S p-1)) ) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓ • S⁻¹ ↓) • S ↑ ^ p-1 • CZ ^ k' ≈⟨ (cright comm⇒pow-comm p-1 k' (sym (axiom comm-CZ-S↑))) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓ • S⁻¹ ↓) • CZ ^ k' • S ↑ ^ p-1 ≈⟨ by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓) • (S⁻¹ ↓ • CZ ^ k') • S ↑ ^ p-1 ≈⟨ (cright cleft (cleft lemma-cong↓-S^ (₁₊ p-2))) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓) • (S ↓ ^ p-1 • CZ ^ k') • S ↑ ^ p-1 ≈⟨ (cright cleft comm⇒pow-comm p-1 k' (sym (axiom comm-CZ-S↓))) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓) • (CZ ^ k' • S ↓ ^ p-1) • S ↑ ^ p-1 ≈⟨ (cright cleft (cright sym (lemma-cong↓-S^ (₁₊ p-2)))) ⟩
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • CZ • H ↓) • (CZ ^ k' • S⁻¹ ↓) • S ↑ ^ p-1 ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 2) (□  • □ ^ 3 • □ ^ 3) auto ⟩
  (S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • (CZ • H ↓ • CZ ^ k') • S⁻¹ ↓ • S ↑ ^ p-1 ≈⟨ (cright (cleft lemma-CZH↓CZ^k k'')) ⟩
  (S⁻¹ ↓ • H ↓ • S⁻¹ ↓) • ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) ^ k' • CZ • H ↓ • S⁻¹ ↓ ^ k' • S⁻¹ ↑ ^ k') • S⁻¹ ↓ • S ↑ ^ p-1 ≈⟨ by-passoc (□ • □ ^ 5 • □ ^ 2) (□ ^ 2 • □ • □ • □ • □ ^ 2 • □) auto ⟩
  ...
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) ^ k) • CZ • H ↓ • S⁻¹ ↓ ^ k' • (S⁻¹ ↓ • S⁻¹ ↑ ^ k') • S ↑ ^ p-1 ≈⟨ by-passoc (□ • □ • □ • □ • □ ^ 2 • □) (□ • □ • □ • □ ^ 2 • □ ^ 2) auto ⟩
  ...
  ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) ^ k) • CZ • H ↓ • (S⁻¹ ↓ ^ k' • S⁻¹ ↓) • S⁻¹ ↑ ^ k ≈⟨ (cright cright cright (cleft comm⇒pow-comm k' 1 refl)) ⟩
  ...
  aux = begin
    ...
    (S⁻¹ ^ k') ↑ • S⁻¹ ↑ ≈⟨ lemma-cong↑ _ _ (M1P.comm⇒pow-comm k' p-1 (M1P.comm⇒pow-comm p-1 1 M1B.refl)) ⟩
...
lemma-eqn17↓ {n@0} = begin
      H ↓ • CZ • S⁻¹ ↓ • H ↓ • H ↑ • CZ ≈⟨  by-passoc (□ ^ 6) (□ ^ 4 • □ ^ 2) auto ⟩
      (H ↓ • CZ • S⁻¹ ↓ • H ↓) • H ↑ • CZ ≈⟨  (cright trans (sym left-unit) (cong (sym (axiom order-CZ)) refl)) ⟩
      (H ↓ • CZ • S⁻¹ ↓ • H ↓) • CZ ^ p • H ↑ • CZ ≈⟨  by-passoc (□ ^ 4 • □ ^ 2 • □ ^ 2) (□ ^ 5 • □ ^ 3) auto ⟩
      (H ↓ • CZ • S⁻¹ ↓ • H ↓ • CZ) • CZ ^ p-1 • H ↑ • CZ ≈⟨  (cleft by-assoc auto) ⟩
      (H ↓ • (CZ • S⁻¹ ↓) • H ↓ • CZ) • CZ ^ p-1 • H ↑ • CZ ≈⟨  (cleft (cright (cleft (cright lemma-cong↓-S^ (₁₊ p-2))))) ⟩
      (H ↓ • (CZ • S ↓ ^ p-1) • H ↓ • CZ) • CZ ^ p-1 • H ↑ • CZ ≈⟨  (cleft cright (cleft comm⇒pow-comm 1 p-1 (axiom comm-CZ-S↓))) ⟩
      (H ↓ • (S ↓ ^ p-1 • CZ) • H ↓ • CZ) • CZ ^ p-1 • H ↑ • CZ ≈⟨  by-passoc (((□ • □ ^ 2 • □ ^ 2) • □ ^ 3)) (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
      (H ↓ • S ↓ ^ p-1) • (CZ • H ↓) • (CZ • CZ ^ p-1) • H ↑ • CZ ≈⟨  (cright cright cleft comm⇒pow-comm 1 p-1 refl) ⟩
      (H ↓ • S ↓ ^ p-1) • (CZ • H ↓) • (CZ ^ p-1 • CZ) • H ↑ • CZ ≈⟨  by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 3 • □ ^ 3) auto ⟩
      (H ↓ • S ↓ ^ p-1) • (CZ • H ↓ • CZ ^ p-1) • CZ • H ↑ • CZ ≈⟨  (cright cleft lemma-CZH↓CZ^k p-2) ⟩
      (H ↓ • S ↓ ^ p-1) • ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓) ^ p-1 • CZ • H ↓ • S⁻¹ ↓ ^ p-1 • S⁻¹ ↑ ^ p-1) • CZ • H ↑ • CZ ≈⟨ (cright cleft (cleft ^-cong ((S⁻¹ ↓ • H ↓ • S⁻¹ ↓)) ((H⁻¹ ↓ • S ↓ • H ↓)) p-1 (lemma-S⁻¹HS⁻¹))) ⟩
      ...
      (H ↓ • S ↓ ^ p-1) • ((H⁻¹ • S ^ p-1 • H) ↓ • CZ • H ↓ • S⁻¹ ↓ ^ p-1 • S⁻¹ ↑ ^ p-1) • CZ • H ↑ • CZ ≈⟨ by-passoc (□ ^ 2 • (□ ^ 3 • □ ^ 4) • □ ^ 3) (□ ^ 5 • □ ^ 7) auto ⟩
      ...
      (H ↓ • S⁻¹ ↓ • H⁻¹ ↓ • S⁻¹ ↓ • H ↓) • CZ • H ↓ • S⁻¹ ↓ ^ p-1 • S⁻¹ ↑ ^ p-1 • CZ • H ↑ • CZ ≈⟨ (cleft aux-HS⁻¹H⁻¹S⁻¹H) ⟩
       ...
       (S ↓ • CZ • H ↓ • H ↑) • (S⁻¹ ↑ • S ↓) • CZ • H ↑ • S⁻¹ ↑ • S⁻¹ ↓ ≈⟨ by-passoc (□ ^ 4 • □ ^ 2 • □ ^ 4) (□ ^ 5 • □ ^ 3 • □ ^ 2) auto ⟩
       (S ↓ • CZ • H ↓ • H ↑ • S⁻¹ ↑) • (S ↓ • CZ • H ↑) • S⁻¹ ↑ • S⁻¹ ↓ ≈⟨ (cright cleft rewrite-sym0 100 auto) ⟩
       (S ↓ • CZ • H ↓ • H ↑ • S⁻¹ ↑) • (CZ • H ↑ • S ↓) • S⁻¹ ↑ • S⁻¹ ↓ ≈⟨ by-passoc (□ ^ 5 • □ ^ 3 • □ ^ 2) (□ ^ 7 • □ ^ 2 • □) auto ⟩
       (S ↓ • CZ • H ↓ • H ↑ • S⁻¹ ↑ • CZ • H ↑) • (S ↓ • S⁻¹ ↑) • S⁻¹ ↓ ≈⟨ (cright cleft lemma-comm-S-w↑ S⁻¹) ⟩
       (S ↓ • CZ • H ↓ • H ↑ • S⁻¹ ↑ • CZ • H ↑) • (S⁻¹ ↑ • S ↓) • S⁻¹ ↓ ≈⟨ by-passoc (□ ^ 7 • □ ^ 2 • □ ) (□ ^ 8 • □ ^ 2) auto ⟩
       ...
       (CZ • S ↓ • H ↓ • H ↑) • S⁻¹ ↑ • CZ • H ↑ • S⁻¹ ↑ ≈⟨ by-passoc (□ ^ 4 • □ ^ 4) (□ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
...
lemma-S^kHCZH'-dual {n} k'@(₁₊ l) = let k = ₁₊ k' in begin
  ...
  (H ↓ • CZ • H ↓ • CZ • S ↑) • (S ↓ • CZ ^ k') • (S ^ k') ↑ • (S ^ k') ↓ ≈⟨ (cright cleft comm⇒pow-comm 1 k' (sym (axiom comm-CZ-S↓))) ⟩
  (H ↓ • CZ • H ↓ • CZ • S ↑) • (CZ ^ k' • S ↓) • (S ^ k') ↑ • (S ^ k') ↓ ≈⟨ by-passoc (□ ^ 5 • □ ^ 2 • □ ^ 2) (□ ^ 4 • □ ^ 2 • □ ^ 3) auto ⟩
  (H ↓ • CZ • H ↓ • CZ) • (S ↑ • CZ ^ k') • S ↓ • (S ^ k') ↑ • (S ^ k') ↓ ≈⟨ (cright cleft comm⇒pow-comm 1 k' (sym (axiom comm-CZ-S↑))) ⟩
  ...
  (H ↓ • CZ • H ↓ • CZ • CZ ^ k') • S ↑ • ((S ^ k') ↑ • S ↓) • (S ^ k') ↓ ≈⟨ by-passoc (□ ^ 5 • □ • □ ^ 2 • □) (□ ^ 5 • □ ^ 2 • □ ^ 2) auto ⟩
...
lemma-comm-S-Ex'↑ {n@0}  = begin
  ...
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • S⁻¹ • CZ • H • S⁻¹ • S⁻¹ ↑) • S ↑ • H • CZ • S • S ↑ ≈⟨ cright by-passoc (□ ^ 7 • □ ^ 5) (□ ^ 6 • □ ^ 2 • □ ^ 4) auto ⟩
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • S⁻¹ • CZ • H • S⁻¹) • (S⁻¹ ↑ • S ↑) • H • CZ • S • S ↑ ≈⟨ (cright cright cleft (cleft refl)) ⟩
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • S⁻¹ • CZ • H • S⁻¹) • (S⁻¹ ↑ • S ↑) • H • CZ • S • S ↑ ≈⟨ (cright cright cleft lemma-cong↑ _ _ (M1P.comm⇒pow-comm p-1 1 M1B.refl)) ⟩
  ...
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • S⁻¹ • CZ • H • S⁻¹) • H • CZ • S • S ↑ ≈⟨ (cright by-passoc (□ ^ 6 • □ ^ 4) (□ ^ 4 • □ ^ 3 • □ ^ 3) auto) ⟩
  ...
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • (S) ^ p-1 • CZ) • (S • H • S) • CZ • S ↑ • S ≈⟨ (cright cleft cright cright comm⇒pow-comm p-1 1 (sym (axiom comm-CZ-S↓))) ⟩
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • CZ • (S) ^ p-1) • (S • H • S) • CZ • S ↑ • S ≈⟨ (cright by-passoc (□ ^ 4 • □ ^ 3 • □ ^ 3) (□ ^ 3 • □ ^ 2 • □ ^ 5) auto) ⟩
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • CZ) • (S ^ p-1 • S) • H • S • CZ • S ↑ • S ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
  ...
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • CZ) • H • S • CZ • S ↑ • S ≈⟨ (cright by-passoc (□ ^ 3 • □ ^ 5) (□ ^ 4 • □ ^ 4) auto) ⟩
  (H ↑ • CZ • H ↑) • (S⁻¹ • H • CZ • H) • S • CZ • S ↑ • S ≈⟨ (cright cleft lemma-S^kHCZH'-dual p-2) ⟩
  (H ↑ • CZ • H ↑) • (H • CZ • H • CZ ^ p-1 • S⁻¹ ↑ • S⁻¹) • S • CZ • S ↑ • S ≈⟨ cright by-passoc (□ ^ 6 • □ ^ 4) (□ ^ 5 • □ ^ 2 • □ ^ 3) auto ⟩
  (H ↑ • CZ • H ↑) • (H • CZ • H • CZ ^ p-1 • S⁻¹ ↑) • (S⁻¹ • S) • CZ • S ↑ • S ≈⟨ (cright cright (cleft comm⇒pow-comm p-1 1 refl)) ⟩
  ...
  (H ↑ • CZ • H ↑) • (H • CZ • H • CZ ^ p-1 • S⁻¹ ↑) • S ↑ • CZ • S ≈⟨ cright by-passoc (□ ^ 5 • □ ^ 3) (□ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
  ...
  (H ↑ • CZ • H ↑) • (H • CZ • H • CZ ^ p-1) • CZ • S ≈⟨ (cright by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto) ⟩
  (H ↑ • CZ • H ↑) • (H • CZ • H) • (CZ ^ p-1 • CZ) • S ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
...
lemma-eqn16↑ {n} = bbc ε (H) aux00
  ...
  aux00 = begin
    ...
    (H ↑ • CZ • H ↑ • H ↓ • CZ) • (S⁻¹ ↓) • (H ↓) • (S⁻¹ ↓) • H ↓ ≈⟨ by-passoc (□ ^ 5 • □ ^ 4) (□ ^ 8 • □) auto ⟩
