...
module Examples.Groups.Symplectic.Lemmas.Coset2-Update-Sym (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
module Completeness where
  ...
  open import Examples.Groups.Symplectic.Proofs.P9 p-2 p-prime
...
--  open NF1.Normal-Form1 using ()
  ...
  Lemma-two-qupit-completeness lm@(case-||ₐ cz pf@(sp , mc2@(m2 , c@(HS^ k)) , mc1@(m1 , ε))) (CZ-gen) = lm''' , w''' , claim''
    ...
    claim'' = begin
      ...
      ⟦ case-||ₐ cz (sp , mc2 , mc1) ⟧₂ • Ex ^ 2 • CZ ≈⟨ sym (by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto) ⟩
      (⟦ case-||ₐ cz (sp , mc2 , mc1) ⟧₂ • Ex) • Ex • CZ ≈⟨ (cong (lemma-case-||ₐ l pf) (sym lemma-comm-Ex-CZ) ) ⟩
      (w' ↑ • ⟦ lm' ⟧₂) • CZ • Ex ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
      w' ↑ • (⟦ lm' ⟧₂ • CZ) • Ex ≈⟨ (cright cleft ihp) ⟩
      w' ↑ • (w'' ↑ • ⟦ lm'' ⟧₂) • Ex ≈⟨ sym (by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto) ⟩
      (w' • w'') ↑ • ⟦ lm'' ⟧₂ • Ex ≈⟨ (cright cdp) ⟩
      (w' • w'') ↑ • w4 ↑ • ⟦ lm''' ⟧₂ ≈⟨ sym (by-passoc (□ ^ 3 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
      w''' ↑ • ⟦ lm''' ⟧₂ ∎
  ...
  Lemma-two-qupit-completeness lm@(case-Ex-| nf1@(s' , m' , c'@(HS^ k')) mc@(m , c@ε) ) (CZ-gen) = lm'' , w'' , claim
    ...
    claim = begin
      ...
      w ↑ • (Ex • dual ⟦ lm' ⟧₂ • Ex) • Ex ≈⟨ by-passoc (□ • □ ^ 3 • □) (□ ^ 5) auto ⟩
  ...
  ... | ₁ | [ ieq ]' = lm'' , (w • w'') , claim
    ...
    claim = begin
      ...
      (w ↑ • w'' ↑ • ⟦ lm'' ⟧₂ • Ex) • Ex ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 3 • □ ^ 2) auto ⟩
  ...
  Lemma-two-qupit-completeness (case-nf1 nf1@(s , m , c@ε)) (CZ-gen) = case-| (m ⁻¹ , ε) nf1 , M m , claim
    ...
    claim = begin
       ...
       (⟦ s ⟧ₛ • CZ^ (m ^1)) • ⟦ m ⟧ₘ ≈⟨ (cleft comm⇒pow-comm (toℕ s) (toℕ (m ^1)) (sym (axiom comm-CZ-S↓))) ⟩
       ...
       (M m ↑ • M (m ⁻¹) ↑) • CZ^ (m ^1) • ⟦ s ⟧ₛ • ⟦ m ⟧ₘ ≈⟨ by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 2 • □ ^ 2) auto ⟩
       ...
       M m ↑ • (CZ • M (m ⁻¹) ↑) • ⟦ s ⟧ₛ • ⟦ m ⟧ₘ ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 4) auto ⟩
  ...
  Lemma-two-qupit-completeness (case-Ex-nf1 nf1@(s , m , c@ε)) (CZ-gen) = case-Ex-| nf1 (m ⁻¹ , ε) , M m , claim
    ...
    claim = begin
      ⟦ case-Ex-nf1 (s , m , ε) ⟧₂ • CZ ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
      ...
      Ex • (S ↑ ^ toℕ s • CZ^ (m ^1)) • ⟦ m ⟧ₘ ↑ ≈⟨ cright (cleft comm⇒pow-comm (toℕ s) (toℕ (m ^1)) (sym (axiom comm-CZ-S↑))) ⟩
      ...
      Ex • (M m  • M (m ⁻¹) ) • CZ^ (m ^1) • S ↑ ^ toℕ s • ⟦ m ⟧ₘ ↑ ≈⟨ cright by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 2 • □ ^ 2) auto ⟩
      ...
      Ex • M m  • (CZ • M (m ⁻¹) ) • S ↑ ^ toℕ s • ⟦ m ⟧ₘ ↑ ≈⟨ cright by-passoc (□ • □ ^ 2 • □) (□ ^ 4) auto ⟩
      Ex • M m  • CZ • (M (m ⁻¹) ) • S ↑ ^ toℕ s • (⟦ m ⟧ₘ ↑) ≈⟨ sym assoc ⟩
      (Ex • M m)  • CZ • (M (m ⁻¹) ) • S ↑ ^ toℕ s • (⟦ m ⟧ₘ ↑) ≈⟨ (cleft lemma-Ex-M m) ⟩
      (M m ↑ • Ex) • CZ • (M (m ⁻¹) ) • S ↑ ^ toℕ s • (⟦ m ⟧ₘ ↑) ≈⟨ by-passoc (□ ^ 2 • □ ^ 4) (□ • □ • □ • □ ^ 2 • □) auto ⟩
      M m ↑ • Ex • CZ • (M (m ⁻¹) • S ↑ ^ toℕ s) • ⟦ m ⟧ₘ ↑ ≈⟨ (cright cright cright cleft comm⇒pow-comm 1 (toℕ s) (aux-comm-m-S↑ (m ⁻¹))) ⟩
  ...
  Lemma-two-qupit-completeness (case-Ex-nf1 nf1@(s , m , c@(HS^ k))) (CZ-gen) = case-|| (₁ , λ ()) ₀ (s , (m , HS^ k) , (-' m , ε)) , M (m ⁻¹) • H , claim
    ...
    claim = begin
      ...
      (M (m ⁻¹) ↑ • Ex) • H ^ 2 • dual ⟦ case-||ₐ ₀ (s , (-' m , ε) , (m , HS^ k)) ⟧₂ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  ...
  ... | (sk , pf' ,  peq)  = lm' , ε , claim
    ...
    claim 
      = begin
      ⟦ case-|| (cz , nz) l pf ⟧₂ • H ↑ ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
  ...
  ... | (sk , pf' ,  peq)  = lm' , ε , claim
    ...
    claim 
      = begin
      ⟦ case-|| (cz , nz) l pf ⟧₂ • S ↑ ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
  ...
  Lemma-two-qupit-completeness (case-|| cz*@(cz , nz) l pf@(kk , mc1 , (m , ε))) (S-gen) = lm' , (S^ (k⁻¹ * a) • H • M -b⁻¹* • S^ -b • H ^ 2) , claim
    ...
    claim = begin
      ...
      CZ^ cz • H^ ₃ ↑ • S^ l ↑ • CZ^ czk • S^ sk ↑ • ⟦ pf' ⟧ₚ ≈⟨ by-passoc (□ ^ 6) (□ • □ • □ ^ 2 • □ ^ 2) auto ⟩
      CZ^ cz • H^ ₃ ↑ • (S^ l ↑ • CZ^ czk) • S^ sk ↑ • ⟦ pf' ⟧ₚ ≈⟨ (cright cright cleft sym (aux-comm-CZ^a-S^b↑ czk l)) ⟩
      CZ^ cz • H^ ₃ ↑ • (CZ^ czk • S^ l ↑) • S^ sk ↑ • ⟦ pf' ⟧ₚ ≈⟨ by-passoc (□ • □ • □ ^ 2 • □ ^ 2) (□ ^ 3 • □ ^ 3) auto ⟩
      ...
      ((S^ (k⁻¹ * a) ↑ • H ↑ • M -b⁻¹* ↑ • S^ -b ↑ • H ↑ ^ 2) • CZ^ a • H ↑ ^ 3 • S^ -b⁻¹ ↑ • S^ (k * a)) • (S^ (l + sk) ↑) • ⟦ pf' ⟧ₚ ≈⟨ by-passoc ((□ ^ 5 • □ ^ 4) • □ ^ 2) ((□ ^ 5 • □ ^ 3) • □ ^ 2 • □) auto ⟩
      ...
      ((S^ (k⁻¹ * a) ↑ • H ↑ • M -b⁻¹* ↑ • S^ -b ↑ • H ↑ ^ 2) • CZ^ a • H ↑ ^ 3 • S^ -b⁻¹ ↑) • S^ (l + sk) ↑ • S^ (k * a) • ⟦ pf' ⟧ₚ ≈⟨ (cright (cright by-passoc (□ ^ 5) (□ ^ 2 • □ ^ 3) auto)) ⟩
      ((S^ (k⁻¹ * a) ↑ • H ↑ • M -b⁻¹* ↑ • S^ -b ↑ • H ↑ ^ 2) • CZ^ a • H ↑ ^ 3 • S^ -b⁻¹ ↑) • S^ (l + sk) ↑ • ((S^ (k * a) • S^ ss) • (H^ ₃ • CZ • H) • ⟦ mc1 ⟧ₘ₊ ↑ • ⟦ mc0 ⟧ₘ₊) ≈⟨ (cright cright cleft lemma-S^k+l (k * a) ss) ⟩
      ((S^ (k⁻¹ * a) ↑ • H ↑ • M -b⁻¹* ↑ • S^ -b ↑ • H ↑ ^ 2) • CZ^ a • H ↑ ^ 3 • S^ -b⁻¹ ↑) • S^ (l + sk) ↑ • (S^ (k * a + ss) • (H^ ₃ • CZ • H) • ⟦ mc1 ⟧ₘ₊ ↑ • ⟦ mc0 ⟧ₘ₊) ≈⟨ by-passoc ((□ • □ ^ 3) • □ ^ 2) (□ • □ • □ • □ ^ 2 • □) auto ⟩
  ...
  Lemma-two-qupit-completeness (case-Ex-| nf1 mc) (H-gen) = (case-Ex-| nf1 mc') , (S^ k , claim)
    ...
    claim = begin
      ⟦ case-Ex-| nf1 mc ⟧₂ • [ H-gen ]ʷ ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
      ...
      Ex • CZ • (S^ k • ⟦ nf1 ⟧₁ ↑) • ⟦ mc' ⟧ₘ₊ ≈⟨ (cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
      Ex • (CZ • S^ k) • ⟦ nf1 ⟧₁ ↑ • ⟦ mc' ⟧ₘ₊ ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ k) (axiom comm-CZ-S↓)) ⟩
      Ex • (S^ k • CZ) • ⟦ nf1 ⟧₁ ↑ • ⟦ mc' ⟧ₘ₊ ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 3) auto ⟩
      (Ex • S^ k) • CZ • ⟦ nf1 ⟧₁ ↑ • ⟦ mc' ⟧ₘ₊ ≈⟨ (cleft lemma-Ex-Sᵏ (toℕ k)) ⟩
      (S ↑ ^ toℕ k • Ex) • CZ • ⟦ nf1 ⟧₁ ↑ • ⟦ mc' ⟧ₘ₊ ≈⟨ (cleft cleft refl' (aux-↑ S (toℕ k))) ⟩
      (S^ k ↑ • Ex) • CZ • ⟦ nf1 ⟧₁ ↑ • ⟦ mc' ⟧ₘ₊ ≈⟨ by-passoc (□ ^ 2 • □ ^ 3) (□ • □ ^ 4) auto ⟩
      (S^ k ↑) • ⟦ case-Ex-| nf1 mc' ⟧₂ ∎
  ...
  Lemma-two-qupit-completeness (case-Ex-| nf1 mc) (S-gen) = (case-Ex-| nf1 mc') , (S^ k , claim)
    ...
    claim = begin
      ⟦ case-Ex-| nf1 mc ⟧₂ • S ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 5) auto ⟩
  ...
  Lemma-two-qupit-completeness (case-| mc nf1) (H-gen ↥) = (case-| mc'  nf1) , ((S ^ toℕ k) , claim)
    ...
    claim = begin
      ...
      ((CZ • S ↑ ^ toℕ k) • ⟦ mc' ⟧ₘ₊ ↑) • ⟦ nf1 ⟧₁ ≈⟨ (cleft cleft comm⇒pow-comm 1 (toℕ k) (axiom comm-CZ-S↑)) ⟩
