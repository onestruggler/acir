...
module Examples.Groups.Symplectic.Ex-Sym (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
module Lemmas0a where
  ...
  lemma-S⁻¹HS⁻¹H {n} = bbc ε H aux00
    ...
    aux00 = begin
      ...
      (S⁻¹ • H • S⁻¹ • H) • H ≈⟨ by-passoc (□ ^ 4 • □) (□ ^ 3 • □ ^ 2) auto ⟩
  ...
  aux-[H⁻¹SH]^k {n} k@(₂₊ k') = begin
    (H⁻¹ • S • H) ^ k ≈⟨ cong refl (aux-[H⁻¹SH]^k (₁₊ k')) ⟩
    (H⁻¹ • S • H) • H⁻¹ • S ^ ₁₊ k' • H ≈⟨ by-assoc auto ⟩
    (H⁻¹ • S • H • H⁻¹) • S ^ ₁₊ k' • H ≈⟨ (cleft rewrite-sym0 100 auto) ⟩
    (H⁻¹ • S) • S ^ ₁₊ k' • H ≈⟨ by-passoc (□ ^ 2 • □ • □) (□ • □ ^ 2 • □) auto ⟩
    H⁻¹ • S ^ k • H ∎
    where
    open PB ((₁₊ n) QRel,_===_)
    open PP ((₁₊ n) QRel,_===_)
  ...
  aux-H⁻¹S⁻¹H⁻¹S⁻¹H⁻¹ {n} = begin
    ...
    aux00 = begin
      ...
      (H⁻¹ • S⁻¹ • H⁻¹ • S⁻¹ • H⁻¹) • S⁻¹ ≈⟨ by-passoc (□ ^ 5 • □) (□ ^ 6) auto ⟩
  ...
  aux-HS⁻¹H⁻¹S⁻¹H {n} = begin
    ...
    aux00 = begin
      HH • (H • S⁻¹ • H⁻¹ • S⁻¹ • H) • HH ≈⟨ by-passoc (□ ^ 2 • □ ^ 5 • □ ^ 2) (□ ^ 3 • □ • □ • □ • □ ^ 3) auto ⟩
  ...
  aux-CZ⁻¹⁻¹ {n} = •-cancelʳ {h = CZ⁻¹} aux00
    ...
    aux00 = begin
      CZ⁻¹ ^ p-1 • CZ⁻¹ ≈⟨ comm⇒pow-comm p-1 1 refl ⟩
      CZ⁻¹ • CZ⁻¹ ^ p-1 ≈⟨ refl ⟩
      CZ⁻¹ ^ p ≈⟨ ^^ CZ p-1 p ⟩
      CZ ^ (p-1 Nat.* p) ≡⟨ Eq.cong (CZ ^_) (NP.*-comm p-1 p) ⟩
      CZ ^ (p Nat.* p-1) ≈⟨ sym (^^ CZ p p-1) ⟩
      (CZ ^ p) ^ p-1 ≈⟨ ^-cong (CZ ^ p) ε p-1 (axiom order-CZ) ⟩
      ε ^ p-1 ≈⟨ ε^k=ε (₁₊ p-2) ⟩
  ...
  lemma-SHCZH {n} = sym (begin
    ...
    H • (S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓ • S⁻¹ ↓ • S⁻¹ ↑) • S ↑ • S ≈⟨ by-passoc (□ • □ ^ 7 • □ ^ 2) (□ • □ ^ 6 • □ ^ 2 • □) auto ⟩
    H • (S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓ • S⁻¹ ↓) • (S⁻¹ ↑ • S ↑) • S ≈⟨ refl ⟩
    H • (S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓ • S⁻¹ ↓) • (S⁻¹ • S) ↑ • S ≈⟨ (cright cright cleft (lemma-cong↑ _ _ (M1P.comm⇒pow-comm p-1 1 M1B.refl))) ⟩
    ...
    H • (S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓ • S⁻¹ ↓) • S ≈⟨ by-passoc (□ • □ ^ 6 • □) (□ ^ 6 • □ ^ 2) auto ⟩
    (H • S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓) • S⁻¹ ↓ • S ≈⟨ (cright cleft lemma-cong↓-S^ p-1) ⟩
    (H • S⁻¹ ↓ • H ↓ • S⁻¹ ↓ • CZ • H ↓) • S⁻¹ • S ≈⟨ (cright comm⇒pow-comm p-1 1 refl) ⟩
    ...
    (H • S⁻¹ • H • S⁻¹ • CZ • H) ≈⟨ by-passoc (□ ^ 6) (□ ^ 4 • □ ^ 2) auto ⟩
  ...
  lemma-SHCZH' {n} = sym (begin
    ...
    H ↑ • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • CZ • H ↑ • S⁻¹ ↑ • S⁻¹ ↓) • S ↓ • S ↑ ≈⟨ by-passoc (□ • □ ^ 7 • □ ^ 2) (□ • □ ^ 6 • □ ^ 2 • □) auto ⟩
    H ↑ • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • CZ • H ↑ • S⁻¹ ↑) • (S⁻¹ ↓ • S ↓) • S ↑ ≈⟨ refl ⟩
    H ↑ • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • CZ • H ↑ • S⁻¹ ↑) • (S⁻¹ • S) ↓ • S ↑ ≈⟨ (cright cright cleft ((comm⇒pow-comm p-1 1 refl))) ⟩
    ...
    (H ↑ • S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • CZ • H ↑) • S⁻¹ ↑ • S ↑ ≈⟨ (cright lemma-cong↑ _ _ (M1P.comm⇒pow-comm p-1 1 M1B.refl)) ⟩
  ...
  lemma-S^kHCZH' {n} ₀ = lemma-SHCZH'
    ...
    open SR word-setoid
    open Commuting-Symplectic (n)
  lemma-S^kHCZH' {n} k'@(₁₊ l) = let k = ₁₊ k' in begin
    (S ^ k) ↑ • H ↑ • CZ • H ↑ ≈⟨ assoc ⟩
    ...
    (H ↑ • CZ • H ↑ • CZ • CZ ^ k') • S ↓ • (S ↑ • (S ^ k')) • (S ^ k') ↑ ≈⟨ (cright cright cleft comm⇒pow-comm 1 k' (axiom comm-S)) ⟩
...
-}
  ...
  lemma-comm-S-Ex' {n}  = begin
    ...
    (H • CZ • H) • (S⁻¹ ↑ • H ↑ • S⁻¹ ↑ • CZ • H ↑ • S⁻¹ ↑) • (S⁻¹ • S) • H ↑ • CZ • S ↑ • S ↓ ≈⟨ (cright cright cleft comm⇒pow-comm p-1 1 refl) ⟩
    ...
    (H • CZ • H) • (H ↑ • CZ • H ↑ • CZ ^ p-1 • S⁻¹ ↓) • (S⁻¹ ↑ • S ↑) • CZ • S ↓ • S ↑ ≈⟨ (cright cright (cleft lemma-cong↑ _ _ (M1P.comm⇒pow-comm p-1 1 M1B.refl))) ⟩
  ...
  lemma-order-ₕ|ₕ {n} = begin
    ...
    H • (HH • CZ^ ₋₁) • CZ • H ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ ^ 2 • □) auto ⟩
  ...
  aux-comm-S⁻¹↑-S {n} = begin
    ...
    S ↑ ^ p-1 • S ≈⟨ comm⇒pow-comm p-1 1 (axiom comm-S) ⟩
  ...
  lemma-CZHCZ^k {n} k'@0 = let k = ₁₊ k' in begin
    ...
    open Sym0-Rewriting (₁₊ n)
    open Pattern-Assoc
  lemma-CZHCZ^k {n} k'@(₁₊ k'') = let k = ₁₊ k' in begin
    ...
    ((S⁻¹ • H • S⁻¹) • CZ • H) • (S⁻¹ • CZ ^ k') • S ↑ ^ p-1 ≈⟨ (cright cleft comm⇒pow-comm p-1 k' (sym (axiom comm-CZ-S↓))) ⟩
    ...
    ((S⁻¹ • H • S⁻¹) ^ k) • CZ • H • S⁻¹ ^ k' • (S⁻¹ ↑ ^ k' • S⁻¹) • S ↑ ^ p-1 ≈⟨ (cright cright cright cright cleft comm⇒pow-comm k' p-1 aux-comm-S⁻¹↑-S) ⟩
    ...
    ((S⁻¹ • H • S⁻¹) ^ k) • CZ • H • (S⁻¹ ^ k' • S⁻¹) • S⁻¹ ↑ ^ k' • S⁻¹ ↑ ≈⟨ (cright cright cright cright comm⇒pow-comm k' 1 refl) ⟩
  ...
  lemma-CZH↑CZ^k {n} k'@0 = let k = ₁₊ k' in begin
    ...
    open Sym0-Rewriting (₁₊ n)
    open Pattern-Assoc
  lemma-CZH↑CZ^k {n} k'@(₁₊ k'') = let k = ₁₊ k' in begin
    CZ • H ↑ • CZ ^ k ≈⟨ by-passoc (□ ^ 4) (□ ^ 3 • □) auto ⟩
    ...
    (S⁻¹ ↑ • H ↑ • S⁻¹ ↑) • ((S⁻¹ ↑ • H ↑ • S⁻¹ ↑) ^ k' • CZ • H ↑ • S⁻¹ ↑ ^ k' • S⁻¹ ^ k') • S⁻¹ ↑ • S ^ p-1 ≈⟨ by-passoc (□ • □ ^ 5 • □ ^ 2) (□ ^ 2 • □ • □ • □ • □ ^ 2 • □) auto ⟩
    ((S⁻¹ ↑ • H ↑ • S⁻¹ ↑) ^ k) • CZ • H ↑ • S⁻¹ ↑ ^ k' • (S⁻¹ ^ k' • S⁻¹ ↑) • S ^ p-1 ≈⟨ (cright cright cright cright cleft comm⇒pow-comm k' 1 (lemma-comm-Sᵏ-w↑ p-1 S⁻¹)) ⟩
    ((S⁻¹ ↑ • H ↑ • S⁻¹ ↑) ^ k) • CZ • H ↑ • S⁻¹ ↑ ^ k' • (S⁻¹ ↑ • S⁻¹ ^ k') • S ^ p-1 ≈⟨ by-passoc (□ • □ • □ • □ • □ ^ 2 • □) (□ • □ • □ • □ ^ 2 • □ ^ 2) auto ⟩
...
-}
  ...
  lemma-HSHSH {n} = begin
    ...
    (S • S ^ p-1) • (H • S • H • S • H) ≈⟨ (cleft comm⇒pow-comm 1 p-1 refl) ⟩
...
-}
  ...
  lemma-eqn17 {n@0} = begin
        ...
        (H ↑ • S ↑ ^ p-1) • ((S⁻¹ ↑ • H ↑ • S⁻¹ ↑) ^ p-1 • CZ • H ↑ • S⁻¹ ↑ ^ p-1 • S⁻¹ ^ p-1) • CZ • H • CZ ≈⟨ (cright cleft (cleft ^-cong ((S⁻¹ ↑ • H ↑ • S⁻¹ ↑)) ((H⁻¹ ↑ • S ↑ • H ↑)) p-1 (lemma-cong↑ _ _ lemma-S⁻¹HS⁻¹))) ⟩
        ...
        (H ↑ • S⁻¹ ↑ • H⁻¹ ↑ • S⁻¹ ↑ • H ↑) • CZ • H ↑ • S⁻¹ ↑ ^ p-1 • S⁻¹ ^ p-1 • CZ • H • CZ ≈⟨ (cleft lemma-cong↑ _ _ aux-HS⁻¹H⁻¹S⁻¹H) ⟩
         ...
         (S ↑ • CZ • H ↑ • H) • (S ↑ • S⁻¹) • CZ • H • S⁻¹ • S⁻¹ ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 p-1 (axiom comm-S)) ⟩
         ...
         (S ↑ • CZ • H ↑ • H • S⁻¹ • CZ • H) • (S ↑ • S⁻¹) • S⁻¹ ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 p-1 (axiom comm-S)) ⟩
         ...
         (CZ • S ↑ • H ↑ • H) • (S⁻¹ • CZ) • H • S⁻¹ ≈⟨ (cright cleft comm⇒pow-comm p-1 1 (sym (axiom comm-CZ-S↓))) ⟩
