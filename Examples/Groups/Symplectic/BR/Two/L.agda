...
module Examples.Groups.Symplectic.BR.Two.L (p-2 : ℕ) (p-prime : Prime (2+ p-2)) where
...
open import Examples.Groups.Symplectic.Completeness1-Sym p-2 p-prime using ()
open import Examples.Groups.Symplectic.Coset2-Update-Sym p-2 p-prime using ()
