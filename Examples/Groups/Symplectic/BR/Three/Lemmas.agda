...
module Examples.Groups.Symplectic.BR.Three.Lemmas (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.Embeding-2n p-2 p-prime 1 as Em
...
lemma-|||-mm m↑@(m↑' , nz↑) m@(m' , nz) = begin
  ...
  CZ02 • ⟦ m↑ ⟧ₘ ↑ ↑ • (CZ • (CZ ↑ ^ toℕ m')) • ⟦ m ⟧ₘ ↑ ≈⟨ cright cright cleft comm⇒pow-comm 1 (toℕ m') (sym (axiom selinger-c12)) ⟩
  CZ02 • ⟦ m↑ ⟧ₘ ↑ ↑ • ((CZ ↑ ^ toℕ m') • CZ) • ⟦ m ⟧ₘ ↑ ≈⟨ cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  ...
  CZ02 • ((CZ^ (m' * m↑')) ↑ • ⟦ m↑ ⟧ₘ ↑ ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  (CZ02 • (CZ^ (m' * m↑')) ↑) • ⟦ m↑ ⟧ₘ ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cleft cright sym (refl' (lemma-^-↑ CZ (toℕ (m' * m↑')))) ⟩
  (CZ02 • (CZ ↑ ^ toℕ (m' * m↑'))) • ⟦ m↑ ⟧ₘ ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cleft comm⇒pow-comm 1 (toℕ (m' * m↑')) (sym lemma-comm-CZ↑-CZ02) ⟩
...
aux-comm-CZ↑-S↑↑ m k = begin
  ...
  CZ ↑ ^ toℕ m • (S ↑ ↑ ^ toℕ k) ≈⟨ comm⇒pow-comm (toℕ m) (toℕ k) (axiom (cong↑ comm-CZ-S↑)) ⟩
...
aux-XC02-CZ^k↑ k = bbc (Ex ↑ • Ex) (Ex • Ex ↑) claim
  ...
  claim = begin
    ...
    (CX ↑ • Ex ↑ • Ex) • CZ^ k ↑ • Ex • Ex ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 3) (□ • (□ ^ 3) • □ ^ 2) auto ⟩
    ...
    (CZ^ k • Ex ↑) • (CZ^ (- k) • Ex) • Ex • Ex ↑ • CX ↑ ≈⟨ cright cleft comm⇒pow-comm (toℕ (- k)) 1 lemma-comm-Ex-CZ-n ⟩
...
aux-CZ02-H-CZ↑ k = begin
  ...
  H ↑ ↑ • CZ^ k ↑ • CZ^ (- k) • XC02 ≈⟨ by-passoc (□ ^ 6) (□ ^ 4 • □ ^ 2) auto ⟩
  (H ↑ ↑ • CZ^ k ↑ • CZ^ (- k) • H ↑ ↑ ^ 3) • CZ02 • H ↑ ↑ ≈⟨ cleft cright cright comm⇒pow-comm (toℕ (- k)) 3 (sym (axiom comm-CZ)) ⟩
  (H ↑ ↑ • CZ^ k ↑ • H ↑ ↑ ^ 3 • CZ^ (- k)) • CZ02 • H ↑ ↑ ≈⟨ by-passoc ((□ • □ • □ ^ 3 • □) • □) ((□ • □ ^ 3 • □) • □ ^ 2) auto ⟩
  (H ↑ ↑ • (CZ^ k ↑ • H ↑ ↑ ^ 2) • H ↑ ↑) • CZ^ (- k) • CZ02 • H ↑ ↑ ≈⟨ sym (cleft cright cleft lemma-cong↑ _ _ (L2Q0.lemma-semi-HH↑-CZ^k'' k)) ⟩
  (H ↑ ↑ • (H ↑ ↑ ^ 2 • CZ^ (- k) ↑) • H ↑ ↑) • CZ^ (- k) • CZ02 • H ↑ ↑ ≈⟨ cleft by-passoc (□ • (□ ^ 2 • □) • □) (□ ^ 3 • □ • □) auto ⟩
  XC'^ (- k) ↑ • CZ^ (- k) • CZ02 • H ↑ ↑  ∎
...
lemma-|||-mhm m↑@(m↑' , nz↑) k  m@(m' , nz) = begin
  ...
  CZ02 • ⟦ m↑ , HS^ k ⟧ₘ₊ ↑ ↑ • (CZ • (CZ ↑ ^ toℕ m')) • ⟦ m ⟧ₘ ↑ ≈⟨ cright cright cleft comm⇒pow-comm 1 (toℕ m') (sym (axiom selinger-c12)) ⟩
  CZ02 • ⟦ m↑ , HS^ k ⟧ₘ₊ ↑ ↑ • ((CZ ↑ ^ toℕ m') • CZ) • ⟦ m ⟧ₘ ↑ ≈⟨ cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  CZ02 • (⟦ m↑ , HS^ k ⟧ₘ₊ ↑ ↑ • (CZ ↑ ^ toℕ m')) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft cright refl' (lemma-^-↑ CZ (toℕ m')) ⟩
  CZ02 • (⟦ m↑ , HS^ k ⟧ₘ₊ ↑ ↑ • (CZ^ m') ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft by-passoc (□ ^ 3 • □) (□ ^ 4) auto ⟩
  CZ02 • (⟦ m↑ ⟧ₘ ↑ ↑ • H ↑ ↑ • S^ k ↑ ↑ • (CZ^ m') ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft cright cright sym (aux-comm-CZ↑-S↑↑ m' k) ⟩
  CZ02 • (⟦ m↑ ⟧ₘ ↑ ↑ • H ↑ ↑ • (CZ^ m') ↑ • S^ k ↑ ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright by-passoc (□ ^ 4 • □) (□ ^ 2 • □ ^ 2 • □) auto ⟩
  CZ02 • (⟦ m↑ ⟧ₘ ↑ ↑ • H ↑ ↑) • (CZ^ m' ↑ • S^ k ↑ ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft lemma-cong↑ _ _ (lemma-cong↑ _ _ (B1.sym (semi-HM' m↑))) ⟩
  CZ02 • (H ↑ ↑ • ⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑) • (CZ^ m' ↑ • S^ k ↑ ↑) • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
  (CZ02 • H ↑ ↑) • (⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑ • CZ^ m' ↑) • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft lemma-cong↑ _ _ (L2Q0.lemma-M↑CZ^k m↑⁻¹ m' ((m↑ ⁻¹) .proj₂))  ⟩
  (CZ02 • H ↑ ↑) • (CZ^ (m' * m↑⁻¹) ↑ • ⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑) • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □) (□ ^ 3 • □ ^ 2) auto ⟩
  (CZ02 • H ↑ ↑ • CZ^ (m' * m↑⁻¹) ↑) • ⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑ • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cleft aux-CZ02-H-CZ↑ mm ⟩
  (XC'^ (- mm) ↑ • CZ^ (- mm) • CZ02 • H ↑ ↑) • ⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑ • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 4 • □ ^ 4) (□ ^ 3 • □ ^ 2 • □ ^ 3) auto ⟩
  (XC'^ (- mm) ↑ • CZ^ (- mm) • CZ02) • (H ↑ ↑ • ⟦ m↑ ⁻¹ ⟧ₘ ↑ ↑) • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ cright cleft sym (lemma-cong↑ _ _ (lemma-cong↑ _ _ (B1.sym (semi-HM' m↑)))) ⟩
  (XC'^ (- mm) ↑ • CZ^ (- mm) • CZ02) • (⟦ m↑ ⟧ₘ ↑ ↑ • H ↑ ↑) • S^ k ↑ ↑ • CZ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 3) (□ ^ 2 • □ • □ ^ 3 • □ ^ 2) auto ⟩
...
aux-XC02-CX^k↑ k = bbc (H ↑) (H ↑ ^ 3) claim
  ...
  claim = begin
    ...
    ε • CZ^ k ↑ • H ↑ • XC^ (- k) • H ↑ ^ 3 • XC02 ≈⟨ cong (rewrite-sym0 100 auto) (cright cright cright comm⇒pow-comm 3 1 (sym aux-comm-XC02-H↑)) ⟩
