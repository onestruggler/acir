...
module Examples.Groups.Symplectic.BR.Three.Lemmas3 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.Ex-Sym4n2 p-2 p-prime hiding (lemma-Ex-M-n)
...
aux-comm-CZ-CZ^k↑ k = begin
  ...
  CZ • CZ ↑ ^ toℕ k ≈⟨ comm⇒pow-comm 1 (toℕ k) (sym (axiom selinger-c12)) ⟩
...
aux-comm-CZ02-CZ^k↑ k = begin
  ...
  CZ02 • CZ ↑ ^ toℕ k ≈⟨ comm⇒pow-comm 1 (toℕ k) (sym lemma-comm-CZ↑-CZ02) ⟩
...
aux-comm-CZ02^l-CZ^k↑ l k = begin
  ...
  CZ02 ^ toℕ l • CZ^ k ↑ ≈⟨ comm⇒pow-comm (toℕ l) 1 (aux-comm-CZ02-CZ^k↑ k)  ⟩
...
lemma-CX⁻¹↑-CZ^k k = bbc (HH ↑ ↑) (HH ↑ ↑) claim
  ...
  claim = begin
    ...
    (CX ↑ • HH ↑ ↑) • CZ^ k • HH ↑ ↑ ≈⟨ cright comm⇒pow-comm (toℕ k) 1 (lemma-comm-CZ-w↑↑ HH) ⟩
    ...
    (CZ^ k • HH ↑ ↑) • CZ02^ k • HH ↑ ↑ • CX ↑ ≈⟨ cong (comm⇒pow-comm (toℕ k) 1 (lemma-comm-CZ-w↑↑ HH)) (cright lemma-cong↑ _ _ lemma-semi-HH↑-CX) ⟩
...
lemma-comm-CZ02^k-S^l k l = begin
  ...
  Ex • (CZ ↑ ^ (toℕ k) • S^ l) • Ex ≈⟨ cright cleft comm⇒pow-comm (toℕ k) (toℕ l) (axiom comm-S) ⟩
...
aux-CZ⁻¹↑-H↑↑-CX02^k k = bbc (Ex ↑) ε claim
  ...
  claim = begin
    ...
    (Ex ↑ • CZ^ (- ₁) ↑) • H ↑ ↑ • CX02^ k ≈⟨ cleft lemma-cong↑ _ _ (P2.comm⇒pow-comm 1 (toℕ (- ₁)) (B2.sym lemma-comm-Ex-CZ)) ⟩
...
aux-[Ex-Ex↑]-XC02^k k = begin
  ...
  H ^ 3 • (Ex • CZ^ k) • H ↑ • Ex ↑ ≈⟨ cright cleft comm⇒pow-comm 1 (toℕ k) (sym lemma-comm-Ex-CZ-n) ⟩
...
aux-CZ⁻¹H↑-XC'^k↑ k = bbc (Ex • Ex ↑) ε claim
  ...
  claim  = begin
    ...
    CZ^ (- ₁) ↑ • (H ↑ ↑ • H ^ 3) • (Ex • Ex ↑ • CZ^ k ↑) • H ↑ ↑ ≈⟨ cright cright (cleft (cright  lemma-cong↑ _ _ (P2.comm⇒pow-comm 1 (toℕ k) (B2.sym lemma-comm-Ex-CZ-n)))) ⟩
    ...
    (H ↑ ↑ • H ^ 3) • (Ex • CZ^ k ↑ • Ex ↑) • H ↑ ↑ • XC02^ k • XC^ (- ₁) ≈⟨ sym (cright cleft cright lemma-cong↑ _ _ (P2.comm⇒pow-comm 1 (toℕ k) (B2.sym lemma-comm-Ex-CZ-n))) ⟩
