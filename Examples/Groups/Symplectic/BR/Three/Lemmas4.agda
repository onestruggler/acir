...
open import Examples.Groups.Symplectic.Lemmas.Ex-Sym4 p-2 p-prime hiding (lemma-Ex-S^ᵏ↑)
...
open import Examples.Groups.Symplectic.Lemmas.Ex-Sym4n4 p-2 p-prime
