...
module Examples.Groups.Symplectic.BR.Three.Fig-40 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
import Examples.Groups.Symplectic.Lemma-Comm-n p-2 p-prime 1 as LCn1
...
aux-Ex-D↑ b@(₁₊ _) nz = begin
  ...
  Ex • Ex ↑ • (CZ ↑ ^ toℕ (- 1ₚ) • CZ^ b⁻¹) • ⟦ (b , λ ()) ⁻¹ ⟧ₘ ↑ ≈⟨ cright cright cleft comm⇒pow-comm (toℕ (- 1ₚ)) (toℕ b⁻¹) (axiom selinger-c12) ⟩
...
aux-D-Ex↑-CZ^k k b@(₁₊ _) nz = begin
  ...
  (CZ^ (- ₁) • CZ^ (k * b⁻¹) ↑) • ⟦ (b , λ ()) ⁻¹ ⟧ₘ ↑ • (Ex • Ex ↑) ≈⟨ cleft comm⇒pow-comm (toℕ (- 1ₚ)) 1 (aux-comm-CZ-CZ^k↑ (k * b⁻¹)) ⟩
...
lemma-dir-and-vd' vd@(d1@(₀ , b1@(₁₊ _)) ∷ d2@(a2@(₁₊ _) , b2) ∷ []) = begin
  ...
  H ↑ ↑ • (CZ^ (a2 * b1⁻¹) ↑ • [ d1 ]ᵈ) • (CZ^ a2 • H ↑ ↑ ^ 3) • (Ex ↑ • CZ^ (- ₁) ↑) • (H ↑ • ⟦ (a2 , λ ()) ⟧ₘ ↑) • S^ -b/a ↑ ≈⟨ cright cright cong (comm⇒pow-comm (toℕ a2) 3 (lemma-comm-CZ-w↑↑ H)) (cright cleft lemma-cong↑ _ _ (semi-HM (a2 , λ ()))) ⟩
...
lemma-dir-and-vd' vd@(d1@(a1@₀ , b1@(₁₊ _)) ∷ d2@(₀ , b2@(₁₊ _)) ∷ []) = begin
  ...
  (CZ^ (- ₁) • CZ^ (b2⁻¹ * b⁻¹) ↑) • ⟦ (b1 , λ ()) ⁻¹ ⟧ₘ ↑ • Ex • [ ₀ , b2 ]ᵈ ↑ ≈⟨ cleft comm⇒pow-comm (toℕ (- ₁)) 1 (aux-comm-CZ-CZ^k↑ (b2⁻¹ * b⁻¹)) ⟩
...
lemma-dir-and-vd' vd@(d1@(a1@(₁₊ _) , b1) ∷ d2@(a2@(₁₊ _) , b2) ∷ []) = begin
  ...
  (H ↑ • H ↑ ↑ • CZ^ k ↑ • S^ (- k) ↑ • H ↑ ^ 3) • Ex • (CZ^ (- ₁) • S^ (- k) ↑ ↑) • H • S^ k • (Ex ↑ • CX^ (- ₁) ↑) • ZM (a1 , λ ()) ↓ • (S^ k ↑ • S^ -b1/a1 ↓) • ZM (a2 , λ ()) ↑ • S^ -b2/a2 ↑ ≈⟨ cright cright  cong (comm⇒pow-comm (toℕ (- ₁)) 1 (lemma-comm-CZ-w↑↑ ( S^ (- k)))) (cright cright cright cright cleft sym (lemma-comm-Sᵏ-w↑ (toℕ -b1/a1) (S^ k))) ⟩
...
lemma-dir-and-vd' vd@(d1@(₀ , ₀) ∷ d2@(a2@(₁₊ _) , b2) ∷ []) = begin
  ...
  H ↑ ↑ • (CZ^ a2 ↑ • [ d1 ]ᵈ) • (CZ^ a2 • H ↑ ↑ ^ 3) • (Ex ↑ • CZ^ (- ₁) ↑) • (H ↑ • ⟦ (a2 , λ ()) ⟧ₘ ↑) • S^ -b/a ↑ ≈⟨ cright cright cong (comm⇒pow-comm (toℕ a2) 3 (lemma-comm-CZ-w↑↑ H)) (cright cleft lemma-cong↑ _ _ (semi-HM (a2 , λ ()))) ⟩
...
lemma-dir-and-vd' vd@(d1@(a1@(₁₊ _) , b1) ∷ d2@(₀ , ₀) ∷ []) = begin
  ...
  (CZ^ (- ₁) • ⟦ (a1 , λ ()) ⁻¹ ⟧ₘ ↑ • H ↑) • (S^ -b/a ↑ • CZ ↑) • Ex • Ex ↑ ≈⟨ cright cleft lemma-cong↑ _ _ (P2.comm⇒pow-comm (toℕ -b/a) 1 (B2.sym (B2.axiom comm-CZ-S↓))) ⟩
  ...
  (H ↑ ^ 2 • CX^ a1 ↑ • CZ02^ a1 • HH ↑) • [ d1 ]ᵈ' • Ex ↑ ≈⟨ cong (cright cright comm⇒pow-comm 1 2 (lemma-comm-CZ02-H↑' a1)) (cleft sym (aux-dd d1)) ⟩
  ...
  (H ↑ ^ 5 • (CZ^ a1) ↑ • H ↑ ^ 3 • ZM (-' (a1 , λ ())) ↑ ↑) • [ d1 ]ᵈ • [ (₀ , - a1) ]ᵈ ↑ ≈⟨ cleft cong (rewrite-sym0 100 auto) (cright lemma-cong↑ _ _ (P2.comm⇒pow-comm 3 1 (lemma-comm-H-w↑ ( ZM (-' (a1 , λ ())) )))) ⟩
...
lemma-dir-and-vd' vd@(d1@(a1@₀ , b1@(₁₊ _)) ∷ d2@(₀ , ₀) ∷ []) = begin
  ...
  (CZ^ (- ₁) • CZ^ b⁻¹ ↑) • ⟦ (b1 , λ ()) ⁻¹ ⟧ₘ ↑ • Ex • Ex ↑ ≈⟨ cleft comm⇒pow-comm (toℕ (- ₁)) 1 (aux-comm-CZ-CZ^k↑ b⁻¹) ⟩
