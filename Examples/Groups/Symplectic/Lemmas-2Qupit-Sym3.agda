...
aux-CXᵏ {n} k@(₁₊ k'@(₁₊ k'')) = begin
  ...
  (H ↓ ^ 3 • CZ • H ↓) • H ^ 3 • CZ ^ k' • H  ≈⟨ by-passoc (□ ^ 3 • □ ^ 3) (□ ^ 4 • □ ^ 2) auto ⟩
...
lemma-semi-HH↑-CX {n@0} = begin
  ...
  H ^ 3 • (CZ^ (- ₁) • HH ↑) • H ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
  (H ^ 3 • CZ^ (- ₁)) • HH ↑ • H ≈⟨ (cright general-comm auto) ⟩
  (H ^ 3 • CZ^ (- ₁)) • H • HH ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ ^ 3 • □) auto ⟩
...
lemma-semi-HH↑-CX⁻¹ {n} = bbc (HH ↑) (HH ↑) claim
  ...
  claim = begin
    HH ↑ • (HH ↑ • CX^ (- ₁)) • HH ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
    ...
    (HH ↑ • CX) • HH ↑ • HH ↑ ≈⟨ sym (by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ) ⟩
    HH ↑ • (CX • HH ↑) • HH ↑ ∎
...
lemma-semi-M↓-XC {n} m = begin
  ...
  (H ↑ ^ 3 • ZM m) • CZ • H ↑  ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ⟩
  H ↑ ^ 3 • (ZM m • CZ) • H ↑  ≈⟨ (cright cleft axiom (semi-M↓CZ m)) ⟩
  H ↑ ^ 3 • (CZ^ (m .proj₁) • ZM m) • H ↑  ≈⟨ sym (by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto) ⟩
  (H ↑ ^ 3 • CZ^ (m .proj₁)) • ZM m • H ↑  ≈⟨ (cright aux-comm-m-w↑ m H) ⟩
  (H ↑ ^ 3 • CZ^ (m .proj₁)) • H ↑ • ZM m  ≈⟨ by-passoc (□ ^ 2 • □ ^ 2) (□ ^ 3 • □) auto ⟩
...
lemma-abox-m {n} x@((a@(₁₊ _), b) , nz) m = begin
  ...
  ⟦ (a , λ ()) ⁻¹ ⟧ₘ • (ZM (m ⁻¹) • H) • S^ (-b/a * m⁻²) ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
