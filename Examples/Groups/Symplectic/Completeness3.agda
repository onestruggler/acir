...
module Examples.Groups.Symplectic.Completeness3 (p-2 : ℕ) (p-prime : Prime (2+ p-2))  where
...
open import Examples.Groups.Symplectic.Ex-Sym4n2 p-2 p-prime as Sym4n
open import Examples.Groups.Symplectic.Ex-Sym4n3 p-2 p-prime as Sym4n3 hiding (module P1)
...
open import Examples.Groups.Symplectic.Pushing.DS p-2 p-prime
...
lemma-coset-update {n@2} lm@(case-I d@(a@(₁₊ a-1) , b) c2@(case-Ex-| nf1 mc@(m , HS^ hs))) g@CZ-gen = {!!}
  ...
  claim = begin
    ...
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • [ d ]ᵈ • (⟦ m ⟧ₘ ↑ ↑ • ⟦ nf1 ⟧₁ ↑) • Ex ↑  ≈⟨ (cright by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • ([ d ]ᵈ • ⟦ m ⟧ₘ ↑ ↑) • ⟦ nf1 ⟧₁ ↑ • Ex ↑  ≈⟨ (cright cong (comm-dbox-w↑↑ d ⟦ m ⟧ₘ) (sym (((lemma-cong↑ _ _ (Sym4n.lemma-Ex-SMC 0 nf1))))) ) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • (⟦ m ⟧ₘ ↑ ↑ • [ d ]ᵈ) • Ex ↑ • ⟦ nf1 ⟧₁ ↑ ↑  ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 2) (□ ^ 4 • □ ^ 3) auto ⟩
...
lemma-coset-update {n@_} lm@(case-I d@(a@(₁₊ a-1) , b) c2@(case-Ex-| nf1 mc@(m , ε))) g@CZ-gen | ₁₊ k-1 | [ eq ]' = lm' , w , claim
  ...
  claim = begin
    ...
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • [ d ]ᵈ • Ex ↑ • (ZM (k' , nzk) • (CZ^ ₁) • ZM ((k' , nzk)⁻¹)) ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (cright cright  by-passoc (□ • □ ^ 3 • □) (□ ^ 2 • □ ^ 3) auto ) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • [ d ]ᵈ • (Ex ↑ • ZM (k' , nzk) ↑) • CZ ↑ • ZM ((k' , nzk)⁻¹) ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (cright cright  (cleft lemma-cong↑ _ _ (lemma-Ex-M ((k' , nzk)))) ) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • [ d ]ᵈ • (ZM (k' , nzk) ↑ ↑ • Ex ↑) • CZ ↑ • ZM ((k' , nzk)⁻¹) ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (cright  by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • ([ d ]ᵈ • ZM (k' , nzk) ↑ ↑) • Ex ↑ • CZ ↑ • ZM ((k' , nzk)⁻¹) ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (cright cleft (comm-dbox-w↑↑ d (ZM (k' , nzk)))  ) ⟩
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3) • (ZM (k' , nzk) ↑ ↑ • [ d ]ᵈ) • Ex ↑ • CZ ↑ • ZM ((k' , nzk)⁻¹) ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (   by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 6) (□ ^ 4 • □ • □ • □ • □ ^ 2 • □ ^ 2) auto ) ⟩
    ...
    (H ↑ • CZ ↑ ^ k • H ↑ ^ 3 • ZM (k' , nzk) ↑ ↑) • [ d ]ᵈ • Ex ↑ • CZ ↑ • (⟦ nf1 ⟧₁ ↑ ↑ • ZM ((k' , nzk)⁻¹) ↑) • ⟦ m ⟧ₘ ↑ • ε ≈⟨ (   cright cright cright cright by-passoc (□ ^ 2 • □ ^ 2) (□ • □ ^ 2 • □) auto ) ⟩
...
lemma-coset-update {n@2} lm@(case-I d@(a@₀ , b@(₁₊ _)) c2@(case-Ex-| nf1 mc@(m , ε))) g@CZ-gen = lm' , w  , claim
  ...
  claim = begin
    ...
    (CZ^ (- ₁) • ⟦ (b , nz) ⁻¹ ⟧ₘ ↑) • (CZ ↑ ^ toℕ m' • (Ex • Ex ↑)) • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □) (□ • □ ^  2 • □ • □) auto ⟩
    ...
    CZ^ (- ₁) • (CZ^ (m' * b⁻¹) ↑ • ⟦ (b , nz) ⁻¹ ⟧ₘ ↑) • (Ex • Ex ↑) • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc  (□ • □ ^  2 • □ • □) (□ ^ 2 • □ ^ 3) auto ⟩
    (CZ^ (- ₁) • CZ^ (m' * b⁻¹) ↑) • ⟦ (b , nz) ⁻¹ ⟧ₘ ↑ • (Ex • Ex ↑) • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ (cleft cright refl' (Eq.sym (lemma-^-↑ CZ (toℕ (m' * b⁻¹))))) ⟩
    (CZ^ (- ₁) • CZ ↑ ^ toℕ (m' * b⁻¹)) • ⟦ (b , nz) ⁻¹ ⟧ₘ ↑ • (Ex • Ex ↑) • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨  (cleft comm⇒pow-comm (toℕ (- ₁)) (toℕ (m' * b⁻¹)) (sym (axiom selinger-c12))) ⟩
    (CZ ↑ ^ toℕ (m' * b⁻¹) • CZ^ (- ₁)) • ⟦ (b , nz) ⁻¹ ⟧ₘ ↑ • (Ex • Ex ↑) • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 2 • □ • □ ^ 2 • □ ^ 2) (□ • □ ^ 3 • □ ^ 3) auto ⟩
...
lemma-coset-update {n@2} lm@(case-I d@(a@₀ , b@₀) c2@(case-Ex-| nf1 mc@(m , HS^ hs))) g@CZ-gen = lm' , w  , claim
  ...
  claim = begin
    ...
    (Ex • ((Ex • CZ • ⟦ nf1 ⟧₁ ↑) • (H • ⟦ m ⁻¹ ⟧ₘ) • S^ hs) ↑) • CZ ≈⟨ by-passoc ((□ • (□ ^ 3 • □ ^ 2 • □)) • □) ((□ • (□ ^ 3 • □ ^ 2)) • □ ^ 2) auto ⟩
    (Ex • ((Ex • CZ • ⟦ nf1 ⟧₁ ↑) • (H • ⟦ m ⁻¹ ⟧ₘ)) ↑) • S^ hs ↑ • CZ ≈⟨ (cright sym (aux-comm-CZ-S^k↑ hs)) ⟩
    (Ex • ((Ex • CZ • ⟦ nf1 ⟧₁ ↑) • (H • ⟦ m ⁻¹ ⟧ₘ)) ↑) • CZ • S^ hs ↑ ≈⟨ by-passoc ((□ • (□ ^ 3 • □ ^ 2)) • □ ^ 2) ((□ • (□ ^ 3 • □ ^ 1)) • □ ^ 2 • □) auto ⟩
    (Ex • ((Ex • CZ • ⟦ nf1 ⟧₁ ↑) • H) ↑) • (⟦ m ⁻¹ ⟧ₘ ↑ • CZ) • S^ hs ↑ ≈⟨ (cright cleft axiom (semi-M↑CZ (m ⁻¹))) ⟩
    (Ex • ((Ex • CZ • ⟦ nf1 ⟧₁ ↑) • H) ↑) • (CZ^ m⁻¹ • ⟦ m ⁻¹ ⟧ₘ ↑) • S^ hs ↑ ≈⟨ cleft by-passoc (□ • □ ^ 3 • □) (□ ^ 3 • □ ^ 2) auto ⟩
    ((Ex • Ex ↑ • CZ ↑) • (⟦ nf1 ⟧₁ ↑ ↑ • H ↑)) • (CZ^ m⁻¹ • ⟦ m ⁻¹ ⟧ₘ ↑) • S^ hs ↑ ≈⟨ sym (cleft cright lemma-cong↑ _ _ (lemma-comm-Hᵏ-w↑ 1 ⟦ nf1 ⟧₁)) ⟩
    ((Ex • Ex ↑ • CZ ↑) • (H ↑ • ⟦ nf1 ⟧₁ ↑ ↑)) • (CZ^ m⁻¹ • ⟦ m ⁻¹ ⟧ₘ ↑) • S^ hs ↑ ≈⟨ by-passoc ((□ ^ 3 • □ ^ 2) • □ ^ 2 • □) (□ ^ 3 • □ • □ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex ↑ • CZ ↑) • H ↑ • (⟦ nf1 ⟧₁ ↑ ↑ • CZ^ m⁻¹) • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ (cright cright cleft comm⇒pow-comm 1 (toℕ m⁻¹) (sym (lemma-comm-CZ-w↑↑ ⟦ nf1 ⟧₁))) ⟩
    (Ex • Ex ↑ • CZ ↑) • H ↑ • (CZ^ m⁻¹ • ⟦ nf1 ⟧₁ ↑ ↑) • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ by-passoc (□ ^ 3 • □ • □ ^ 2 • □ ^ 2) (□ ^ 4 • □ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex ↑ • CZ ↑ • H ↑) • (CZ^ m⁻¹ • ⟦ nf1 ⟧₁ ↑ ↑) • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ (cleft rewrite-powers 100 auto) ⟩
    (Ex • Ex ↑ • H ↑ • CX ↑) • (CZ^ m⁻¹ • ⟦ nf1 ⟧₁ ↑ ↑) • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ by-passoc (□ ^ 4 • □ ^ 2 • □) (□ ^ 3 • □ ^ 2 • □ ^ 2) auto ⟩
    ...
    (H ↑ ↑ • Ex • Ex ↑) • (CZ ^ k • CZ02⁻ᵏ k • CX ↑) • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 3 • □) (□ • (□ ^ 2 • □) • □ ^ 2 • □) auto ⟩
    ...
    H ↑ ↑ • (CZ ↑ ^ k • Ex • Ex ↑) • (CZ02'⁻ᵏ k • CX ↑) • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ (cright by-passoc (□ ^ 3 • (□ ^ 3 • □) • □ ) (□ ^ 2 • □ ^ 2 • □ ^ 4) auto) ⟩
    ...
    H ↑ ↑ • (CZ ↑ ^ k • Ex) • CZ^ (- m⁻¹) • (ZM ((m) ⁻¹) • ZM (m)) • Ex ↑ • CX ↑ • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ • □ ^ 2 • □ • □ ^ 3 • □ ^ 2) (□ • □ ^ 2 • □ ^ 2 • □ • □ • □ • □ • □ ^ 2 • □) auto ⟩
    ...
    H ↑ ↑ • (CZ ↑ ^ k • Ex) • (ZM ((m) ⁻¹) • CZ^ (- ₁)) • ZM (m) • Ex ↑ • H ↑ ^ 3 • CZ ↑ • (⟦ nf1 ⟧₁ ↑ ↑ • H ↑) • ⟦ m ⁻¹ ⟧ₘ ↑ • S^ hs ↑ ≈⟨ (cright cright cright cright  by-passoc (□ • □ • □ • □ ^ 2 • □ ^ 2) (□ ^ 2 • □ • □ • □ ^ 2 • □) auto) ⟩
    ...
    H ↑ ↑ • (CZ ↑ ^ k • Ex) • (ZM ((m) ⁻¹) • CZ^ (- ₁)) • (H ↑ ↑ ^ 3 • ZM (m)) • ⟦ c2 ⟧₂ ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □ ^ 2 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
    (H ↑ ↑ • CZ ↑ ^ k) • (Ex • ZM ((m) ⁻¹)) • (CZ^ (- ₁) • H ↑ ↑ ^ 3) • ZM (m) • ⟦ c2 ⟧₂ ↑ ≈⟨ (cright cong (Sym4n.lemma-Ex-M-n 1 ((m) ⁻¹)) (cleft comm⇒pow-comm (toℕ (- ₁)) 3 (lemma-comm-CZ-w↑↑ H))) ⟩
    (H ↑ ↑ • CZ ↑ ^ k) • (ZM ((m) ⁻¹) ↑ • Ex) • (H ↑ ↑ ^ 3 • CZ^ (- ₁)) • ZM (m) • ⟦ c2 ⟧₂ ↑ ≈⟨ by-passoc (□ ^ 2 • □ ^ 2 • □ ^ 2 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □ ^ 3) auto ⟩
    (H ↑ ↑ • CZ ↑ ^ k • ZM ((m) ⁻¹) ↑) • (Ex • H ↑ ↑ ^ 3) • CZ^ (- ₁) • ZM (m) • ⟦ c2 ⟧₂ ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 3 (lemma-comm-Ex-w↑↑ H)) ⟩
    (H ↑ ↑ • CZ ↑ ^ k • ZM ((m) ⁻¹) ↑) • (H ↑ ↑ ^ 3 • Ex) • CZ^ (- ₁) • ZM (m) • ⟦ c2 ⟧₂ ↑ ≈⟨ (cleft cright cleft refl' (lemma-^-↑ CZ k)) ⟩
    (H ↑ ↑ • (CZ ^ k) ↑ • ZM ((m) ⁻¹) ↑) • (H ↑ ↑ ^ 3 • Ex) • CZ^ (- ₁) • ZM (m) • ⟦ c2 ⟧₂ ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □ ^ 3) (□ ^ 4 • □ • □ • □ ^ 2) auto ⟩
    (H ↑ • CZ ^ k • ZM ((m) ⁻¹) • H ↑ ^ 3) ↑ • Ex • CZ^ (- ₁) • ZM ((m)) • ⟦ c2 ⟧₂ ↑ ≈⟨ (cright cright cright cleft sym (aux-MM (((m)⁻¹ ⁻¹) .proj₂) ((m) .proj₂) (inv-involutive (m)))) ⟩
    (H ↑ • CZ ^ k • ZM ((m) ⁻¹) • H ↑ ^ 3) ↑ • Ex • CZ^ (- ₁) • ZM ((m)⁻¹ ⁻¹) • ⟦ c2 ⟧₂ ↑ ≈⟨  (cright by-passoc (□ ^ 4) (□ ^ 3 • □) auto) ⟩
...
lemma-coset-update {n@2} lm@(case-I d@(a@₀ , b@₀) c2@(case-Ex-| nf1 mc@(m , ε))) g@CZ-gen = lm' , w  , claim
  ...
  claim = begin
    ...
    (Ex • Ex ↑ • CZ ↑ • ⟦ nf1 ⟧₁ ↑ ↑) • CZ^ m' • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 4 • □ ^ 2) (□ ^ 3 • □ ^ 2 • □) auto ⟩
    (Ex • Ex ↑ • CZ ↑) • (⟦ nf1 ⟧₁ ↑ ↑ • CZ^ m') • ⟦ m ⟧ₘ ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ m') (sym (lemma-comm-CZ-w↑↑ ⟦ nf1 ⟧₁))) ⟩
    (Ex • Ex ↑ • CZ ↑) • (CZ^ m' • ⟦ nf1 ⟧₁ ↑ ↑) • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ ^ 3 • □ ^ 2 • □) (□ ^ 2 • □ ^ 2 • □ ^ 2) auto ⟩
    (Ex • Ex ↑) • (CZ ↑ • CZ^ m') • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ (cright cleft comm⇒pow-comm 1 (toℕ m') (axiom selinger-c12)) ⟩
    (Ex • Ex ↑) • (CZ^ m' • CZ ↑) • ⟦ nf1 ⟧₁ ↑ ↑ • ⟦ m ⟧ₘ ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □) (□ ^ 2 • □ ^ 2) auto ⟩
...
lemma-coset-update {n@2} lm@(case-I d c2@(case-nf1 nf1@(s , mc@(m , ε)))) CZ-gen = lm' , w , claim
  ...
  claim = begin
    ...
    ([ d ]ᵈ • ⟦ rm-mc2 c2 ⟧₂ ↑) • (H ^ 3 • CZ ^ 0 • H) • (CZ^ y • (⟦ m ⟧ₘ • ε) ↑) ≈⟨ by-passoc (□ ^ 2 • □ ^ 3 • □ ^ 2) (□ • □ ^ 2 • □ ^ 3 • □) auto ⟩
    [ d ]ᵈ • (⟦ rm-mc2 c2 ⟧₂ ↑ • H ^ 3) • (CZ ^ 0 • H • CZ^ y) • (⟦ m ⟧ₘ • ε) ↑ ≈⟨ (cright cleft sym (lemma-comm-Hᵏ-w↑ 3 ⟦ rm-mc2 c2 ⟧₂)) ⟩
    [ d ]ᵈ • (H ^ 3 • ⟦ rm-mc2 c2 ⟧₂ ↑) • (CZ ^ 0 • H • CZ^ y) • (⟦ m ⟧ₘ • ε) ↑ ≈⟨ by-passoc (□ • □ ^ 2 • □) ((□ ^ 2 • □) • □) auto ⟩
