...
--
-- Derived rules for M and H
--
-- Arithmetic of S-powers (lemma-S^k+l and friends), H • H ≈ M ₋₁, and
-- the conjugation rules moving M past H.  These need the rewriting
-- tactic of Tactics, which is why they are not in Lemmas.
------------------------------------------------------------------------
...
module Examples.Groups.Symplectic.Simplified.LemmasM
  (p-2 : ℕ)
...
open import Examples.Groups.Symplectic.Simplified.Tactics p-2 p-prime g* g-gen
