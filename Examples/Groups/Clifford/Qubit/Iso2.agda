...
module Examples.Groups.Clifford.Qubit.Iso2 where
...
-- The structural model, opened wholesale: it supplies p-2, p-prime, Φ,
-- ι, inc, Cliff, _≈ᵛ_, _∙ᵛ_, εᵛ, _⁻¹ᵛ, incl, φᵍ, ⟦_⟧ᵛ, symp-⟦⟧ᵛ,
-- ker⊆im-incl and the group bundle.
open import Examples.Groups.Clifford.Qubit.VSp
