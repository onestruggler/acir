...
module Lemmas1-S (n : ℕ) where
  ...
  {- DEAD CLUSTER (commented out 2026-06-23).
     ...
     Examples.Groups.Clifford.Qupit.Simplified-V2.SemiM.SemiS.completeness-semi-MR; repointing these here
  ...
  {- DEAD CLUSTER (commented out 2026-06-23): -S copies of the semi-MR
     ...
     Examples.Groups.Clifford.Qupit.Simplified-V2.SemiM.SemiS.completeness-semi-MR (repointing here would
