...
open import Examples.Groups.Clifford.Qupit.Simplified-V1.Forward p-3 p-prime g* g-gen
...
module M (n : ℕ) where
  ...
  open import Data.Fin.Properties using (toℕ-fromℕ<)
  open import Data.Nat.DivMod using (_%_ ; _/_ ; m≡m%n+[m/n]*n ; m%n<n)
  import Examples.Groups.Clifford.Qupit.Simplified-V1.Syntactics
    p-3 p-prime g* g-gen as Cli
  import Examples.Groups.Clifford.Qupit.Simplified-V1.Lemmas
