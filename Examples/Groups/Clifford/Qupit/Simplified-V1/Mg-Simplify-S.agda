...
module Examples.Groups.Clifford.Qupit.Simplified-V1.Mg-Simplify-S
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.Clifford.Qupit.Simplified-V1.Simplified-Lemmas p-3 p-prime g* g-gen
