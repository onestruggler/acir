...
module Examples.Groups.Clifford.Qupit.Simplified-V1.Clifford-Mod-Scalar.LemmasXZ
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
open import Examples.Groups.Clifford.Qupit.Simplified-V1.Clifford-Mod-Scalar.Lemmas p-3 p-prime g* g-gen using (module Lemmas1 ; module Clifford-GroupLike)
open import Examples.Groups.Clifford.Qupit.Simplified-V1.Clifford-Mod-Scalar.Tactics p-3 p-prime g* g-gen using (module Sim-Rewriting)
