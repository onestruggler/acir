...
module Examples.Groups.Clifford.Qupit.Mg-Simplify
  (p-3 : ℕ)
  (let p-2 = ₁₊ p-3)
...
-- ════════════════════════════════════════════════════════════════════
open import Examples.Groups.Clifford.Qupit.Clifford-Lemmas p-3 p-prime g* g-gen using (lemma-comm-Z↑-CZ ; lemma-comm-Z-CZ ; lemma-M₋₁-CZ)
