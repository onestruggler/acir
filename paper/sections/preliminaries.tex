...
as input and \emph{verify} it against five equational hypotheses
relating the table, the section, and the relations, while the
Reidemeister--Schreier step itself, from a verified table to a normal
form one level up, is proved once and for all (\S\ref{sec:engine}).
...
\subsection{Specialization to circuits}\label{sec:circuit-chain}
