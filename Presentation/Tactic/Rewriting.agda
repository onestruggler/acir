...
module Presentation.Tactic.Rewriting where
...
module Commuting
  ...
  open import Presentation.Properties Γ
    renaming (fl-homo to from-list-homo ; lemma-ft to lemma-from-to)
...
module Rewriting
  ...
  module Step
    ...
    open Strict
    open PP Γ renaming (fl-homo to from-list-homo ; lemma-ft to lemma-from-to)
    open PB Γ
    open SR word-setoid
