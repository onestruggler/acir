...
^-• w v (₁₊ zero) eq = refl
^-• w v (₂₊ a) eq = begin
    (w • v) • (w • v) ^ ₁₊ a        ≈⟨ cong refl (^-• w v (₁₊ a) eq) ⟩
    (w • v) • w ^ ₁₊ a • v ^ ₁₊ a   ≈⟨ sym assoc ⟩
    ((w • v) • w ^ ₁₊ a) • v ^ ₁₊ a ≈⟨ cong assoc refl ⟩
    (w • (v • w ^ ₁₊ a)) • v ^ ₁₊ a ≈⟨ cong (cong refl (comm⇒pow-comm 1 (₁₊ a) (sym eq))) refl ⟩
    (w • (w ^ ₁₊ a • v)) • v ^ ₁₊ a ≈⟨ sym (cong assoc refl) ⟩
    ((w • w ^ ₁₊ a) • v) • v ^ ₁₊ a ≈⟨ assoc ⟩
    (w • w ^ ₁₊ a) • v • v ^ ₁₊ a ∎
  where open SR word-setoid
