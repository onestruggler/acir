...
--
-- Alternative amalgamated products of three group presentations.
------------------------------------------------------------------------
...
module ANFP₁
  (rz : WRel Z)
  (nfp-rz : PP.NormalFormWithoutInverse rz)
  (C₁ : Set)
  (h₁ : C₁ ⊎ ⊤ → X ⊎ Z → Word Z × (C₁ ⊎ ⊤))
  ([_]ₒ₁ : C₁ → Word (X ⊎ Z))
...
module ANFP₂
  (rx : WRel X)
  (nfp-rx : PP.NormalFormWithoutInverse rx)
  (C₁ : Set)
  (h₁ : C₁ ⊎ ⊤ → X ⊎ Y → Word X × (C₁ ⊎ ⊤))
  ([_]ₒ₁ : C₁ → Word (X ⊎ Y))
...
module ANFP₃
  (ry : WRel Y)
  (nfp-ry : PP.NormalFormWithoutInverse ry)
  (C₁ : Set)
  (h₁ : C₁ ⊎ ⊤ → X ⊎ Y → Word Y × (C₁ ⊎ ⊤))
  ([_]ₒ₁ : C₁ → Word (X ⊎ Y))
