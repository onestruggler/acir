...
-- given NormalFormWithoutInverse for S and R and two compatibility conditions on the
-- conjugation action, SplitExtensionRel2 has NormalForm (Theorem
...
--
-- Given:
--   • NormalForm S  (S is a complete presentation of the kernel N)
--   • NormalForm R  (R is a complete presentation of the quotient G/N)
--   • conj-hyp-S : the conjugation by each x respects S-equivalence
--   • conj-wd-R  : the conjugation action is well-defined on R-classes
--
-- we construct NormalForm (SplitExtensionRel2 S R conj-corr).
--
...
module SplitProof
  ...
  module NFP
    ...
    ----------------------------------------------------------------------
    -- The normal form and NormalForm.
    ----------------------------------------------------------------------
