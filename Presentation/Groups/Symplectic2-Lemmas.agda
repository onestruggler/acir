...
module Sym2 where
  ...
  open  NormalForm ExM-nfp' renaming (by-equal-nf to by-ex-nf)
  ...
  Sym2-nfp' : NormalForm _===_
  Sym2-nfp' = MyNFP'.nfp' ExM-nfp'

  -- open NormalForm Sym2-nfp' renaming (nf to nfSym2)
  -- t : {!nfSym2 (S1 • CX)!}
  -- t = {!!}
